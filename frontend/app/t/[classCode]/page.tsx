      ...
      <section className="auth__aside">
        ...
        >
          ...
          <p style={{ color: "#b9c6ce", fontSize: 15, lineHeight: 1.55, maxWidth: 420 }}>
            36 short questions, about eight minutes. Just say how much you would enjoy doing
            each thing -- there are no right or wrong answers.
          </p>
        </motion.div>
      </section>
      ...
      <section className="auth__panel">
        ...
        >
          <div>
            ...
            <h2 style={{ fontSize: 23, marginTop: 4 }}>Before you start</h2>
          </div>

          <div className="evidence evidence--neutral">
            Your school has your parent or guardian&apos;s consent for this activity. Your answers go to your
            school&apos;s counsellor, <strong>not to other students</strong>.
          </div>
