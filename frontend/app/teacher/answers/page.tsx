...
export default function AnswersPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        // Both scoped server-side to this teacher key's own subject assignments -- the
        // paper list to the subjects held, the section list to (section, subject) pairs.
  ...
  // A class only ever offered here if this teacher holds a *subject* assignment on it
  // for the paper currently chosen -- entering marks is a subject right (spec §10.2's
  // default), so a class assignment alone (can_read_all_subjects) never qualifies, no
  // matter how many other screens it opens.
