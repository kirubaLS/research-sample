...
chapter: X.GEO.MANUFACTURING | book: Contemporary India – II (Geography), Class X | edition: NCERT reprint 2026-27 | pages: 75–87
...
#### Box
unit: X.GEO.MANUFACTURING.0.box1 | kind: box | parent: X.GEO.MANUFACTURING.0 | page: 75
...
**Activity** · kind: activity (supporting evidence) · page 75
> Do you have some ideas about these industries?

## 1 Importance of Manufacturing
unit: X.GEO.MANUFACTURING.1 | kind: section | pages: 76 | catalog: X.GEO.CF.IMPORTANCE_MANUFACTURING
...
- p77: Fig. 6.1: Value addition in the textile industry

### 2.1 Textile Industry
unit: X.GEO.MANUFACTURING.2.1 | kind: subsection | parent: X.GEO.MANUFACTURING.2 | pages: 77 | catalog: X.GEO.CF.TEXTILE_INDUSTRY
...
### 2.1.1 Cotton Textiles
unit: X.GEO.MANUFACTURING.2.1.1 | kind: subsection | parent: X.GEO.MANUFACTURING.2.1 | pages: 77 | catalog: X.GEO.CF.COTTON_TEXTILES
...
**Key terms (printed in bold)** · Textile Industry; Why is it important for our country to; keep the mill sector loomage lower than; power loom and handloom?

**Activity** · kind: activity (supporting evidence) · page 77
> Why did Mahatma Gandhi lay emphasis on spinning yarn and weaving khadi?

**CBSE map items linked to this unit** · Cotton textile industry: Mumbai; Cotton textile industry: Indore; Cotton textile industry: Surat (shown on the map only, not named in the text); Cotton textile industry: Kanpur; Cotton textile industry: Coimbatore

### 2.1.2 Jute Textiles
unit: X.GEO.MANUFACTURING.2.1.2 | kind: subsection | parent: X.GEO.MANUFACTURING.2.1 | pages: 77–79 | catalog: X.GEO.CF.JUTE_TEXTILES
...
#### Box
unit: X.GEO.MANUFACTURING.2.1.2.box1 | kind: box | parent: X.GEO.MANUFACTURING.2.1.2 | page: 77
...
**Figures and tables** · kind: caption (supporting evidence)
- p78: India: Distribution of cotton, woollen and silk industries

### 2.2 Sugar Industry
unit: X.GEO.MANUFACTURING.2.2 | kind: subsection | parent: X.GEO.MANUFACTURING.2 | pages: 79 | catalog: X.GEO.CF.SUGAR_INDUSTRY
...
unit: X.GEO.MANUFACTURING.3 | kind: section | pages: 79 | catalog: X.GEO.CF.MINERAL_BASED_INDUSTRIES
...
unit: X.GEO.MANUFACTURING.3.1 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 79–81 | catalog: X.GEO.CF.IRON_STEEL_INDUSTRY
...
**Key terms (printed in bold)** · Processes of Manufacture of Steel

**Activity** · kind: activity (supporting evidence) · page 79
> Make a list of all such goods made of steel that you can think of.

**Figures and tables** · kind: caption (supporting evidence)
- p79: Fig. 6.2
- p80: India: Iron and Steel Plants

**CBSE map items linked to this unit** · Iron and steel plant: Durgapur (shown on the map only, not named in the text); Iron and steel plant: Bokaro; Iron and steel plant: Jamshedpur; Iron and steel plant: Bhilai; Iron and steel plant: Vijayanagar (shown on the map only, not named in the text); Iron and steel plant: Salem (shown on the map only, not named in the text)

### 3.2 Aluminium Smelting
unit: X.GEO.MANUFACTURING.3.2 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 81 | catalog: X.GEO.CF.ALUMINIUM_SMELTING
...
Aluminium smelting plants in the country are located in Odisha, West Bengal, Kerala, Uttar Pradesh, Chhattisgarh, Maharashtra and Tamil Nadu. Bauxite, the raw material used in the smelters is a very bulky, dark reddish coloured rock. The flow chart given below shows the process of manufacturing aluminium. Regular supply of electricity and an assured source of raw material at minimum cost are the two prime factors for location of the industry.

### 3.3 Chemical Industries
unit: X.GEO.MANUFACTURING.3.3 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 81–82 | catalog: X.GEO.CF.CHEMICAL_INDUSTRIES
...
### 3.5 Cement Industry
unit: X.GEO.MANUFACTURING.3.5 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 82 | catalog: X.GEO.CF.CEMENT_INDUSTRY
...
unit: X.GEO.MANUFACTURING.3.6 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 82 | catalog: X.GEO.CF.AUTOMOBILE_INDUSTRY
...
### 3.7 Information Technology and Electronics Industry
unit: X.GEO.MANUFACTURING.3.7 | kind: subsection | parent: X.GEO.MANUFACTURING.3 | pages: 82 | catalog: X.GEO.CF.INFORMATION_TECHNOLOGY_ELECTRONICS_INDUSTRY
...
Rupnarainpur (West Bengal) The first cement plant was set-up in Chennai in 1904. After Independence the industry expanded.

**Key terms (printed in bold)** · Electronics Industry

**Activity** · kind: activity (supporting evidence) · page 82
> Where would it be economically viable to set up the cement manufacturing units? Find out where the plants are located in other States of India. Find their names.

**Figures and tables** · kind: caption (supporting evidence)
- p82: Fig. 6.6: Cable manufacturing facilities at HCL,

**CBSE map items linked to this unit** · Software technology park: Noida; Software technology park: Gandhinagar (shown on the map only, not named in the text); Software technology park: Mumbai; Software technology park: Pune; Software technology park: Hyderabad; Software technology park: Bengaluru; Software technology park: Chennai; Software technology park: Thiruvananthapuram (shown on the map only, not named in the text)

## 4 Industrial Pollution and Environmental Degradation
unit: X.GEO.MANUFACTURING.4 | kind: section | pages: 83–84 | catalog: X.GEO.CF.INDUSTRIAL_POLLUTION_ENVIRONMENTAL_DEGRADATION
...
Thermal pollution of water occurs when hot water from factories and thermal plants is drained into rivers and ponds before cooling. What would be the effect on aquatic life? Wastes from nuclear power plants, nuclear and weapon production facilities cause cancers, birth defects and miscarriages. Soil and water pollution are closely related.
...
**Figures and tables** · kind: caption (supporting evidence)
- p85: Fig. 6.7: Sewage Treatment plant under Yamuna
- p85: action plan at Faridabad
- p85: Fig. 6.8: Ramagundam plant

## Exercises
unit: X.GEO.MANUFACTURING.EX | kind: exercise (never used as evidence) | pages: 85–87
...
(a) Steel (c) Aluminium Smelting (b) Electronic (d) Information Technology
2. Answer the following briefly in not more than 30 words. (i) What is manufacturing? (ii) What are basic industries? Give an example.
...
1. Textiles, sugar, vegetable oil and plantation industries deriving raw materials from agriculture are called… 2. The basic raw material for sugar industry. 3. This fibre is also known as the ‘Golden Fibre’. 4. Iron-ore, coking coal, and limestone are the chief raw materials of this industry. 5. A public sector steel plant located in Chhattisgarh.
ACTIVITY
Solve the puzzle by following your search horizontally and vertically to find the hidden answers.
G P V A R A N A S I
