...
chapter: X.GEO.MINERALSENERGY | book: Contemporary India – II (Geography), Class X | edition: NCERT reprint 2026-27 | pages: 59–74
...
**Key terms (printed in bold)** · minerals; mine

#### Box
unit: X.GEO.MINERALSENERGY.0.box1 | kind: box | parent: X.GEO.MINERALSENERGY.0 | page: 59
...
#### Box: A bright smile from toothpaste and minerals
unit: X.GEO.MINERALSENERGY.0.box2 | kind: box | parent: X.GEO.MINERALSENERGY.0 | page: 59 | catalog: X.GEO.CF.BRIGHT_SMILE_FROM_TOOTHPASTE_MINERALS
...
#### Box: All living things need minerals
unit: X.GEO.MINERALSENERGY.0.box3 | kind: box | parent: X.GEO.MINERALSENERGY.0 | page: 59 | catalog: X.GEO.CF.ALL_LIVING_THINGS_NEED_MINERALS
...
#### Box
unit: X.GEO.MINERALSENERGY.0.box4 | kind: box | parent: X.GEO.MINERALSENERGY.0 | page: 59

Facts” printed on food labels.

**Dig a little deeper and find out how many** · kind: activity (supporting evidence) · page 59
> minerals are used to make a light bulb?

**Dig a little deeper and collect “Nutritional** · kind: activity (supporting evidence) · page 59
> 

## 1 What is a mineral?
unit: X.GEO.MINERALSENERGY.1 | kind: section | pages: 59–60 | catalog: X.GEO.CF.WHAT_IS_MINERAL
...
**Key terms (printed in bold)** · minerals; material; mine; Mica; Limestone

#### Box: Study of Minerals by Geographers and Geologists
unit: X.GEO.MINERALSENERGY.1.box1 | kind: box | parent: X.GEO.MINERALSENERGY.1 | page: 60 | catalog: X.GEO.CF.STUDY_MINERALS_BY_GEOGRAPHERS_GEOLOGISTS
...
### 2.1 Rat-Hole Mining
unit: X.GEO.MINERALSENERGY.2.1 | kind: box | parent: X.GEO.MINERALSENERGY.2 | pages: 61 | catalog: X.GEO.CF.RAT_HOLE_MINING

Do you know that most of the minerals in India are nationalised and their extraction is possible only after obtaining due permission from the government? But in most of the tribal areas of the north-east India, minerals are owned by individuals or communities. In Meghalaya, there are large deposits of coal, iron ore, limestone and dolomite etc. Coal mining in Jowai and Cherapunjee is done by family member in the form of a long narrow tunnel, known as ‘Rat hole’ mining. The National Green Tribunal has declared such activities illegal and recommended that these should be stopped forthwith.

**Key terms (printed in bold)** · minerals; alluvial; deposits; mine; Ferrous Minerals; Iron Ore; Non-Ferrous Minerals; Non-Metallic Minerals; Mica; Limestone; Coal; Petroleum

### 2.2 Ferrous Minerals
unit: X.GEO.MINERALSENERGY.2.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.2 | pages: 61 | catalog: X.GEO.CF.FERROUS_MINERALS
...
### 2.2.1 Iron Ore
unit: X.GEO.MINERALSENERGY.2.2.1 | kind: subsection | parent: X.GEO.MINERALSENERGY.2.2 | pages: 61–62 | catalog: X.GEO.CF.IRON_ORE
...
**Key terms (printed in bold)** · deposits; mine

**Dig a little deeper: What is the difference between an open pit mine, a quarry and an** · kind: activity (supporting evidence) · page 61
> underground mine with shafts?

### 2.2.2 Manganese
unit: X.GEO.MINERALSENERGY.2.2.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.2.2 | pages: 62 | catalog: X.GEO.CF.MANGANESE
...
#### Box
unit: X.GEO.MINERALSENERGY.2.2.2.box1 | kind: box | parent: X.GEO.MINERALSENERGY.2.2.2 | page: 62

coal and iron and steel industry. Do you see

**Dig a little deeper: Superimpose the maps showing distribution of iron ore, manganese,** · kind: activity (supporting evidence) · page 62
> 

**Activity** · kind: activity (supporting evidence) · page 62
> any correlation. Why?

**Figures and tables** · kind: caption (supporting evidence)
- p62: Fig. 5.2: Iron ore mine
- p62: Andhra Pradesh
- p62: Others
- p62: 2%
- p62: 10%
...
- p62: Maharashtra
- p62: 27%
- p62: Fig. 5.3: Production of Manganese showing
- p62: state-wise share in per cent, 2018–19

### 2.3 Non-Ferrous Minerals
unit: X.GEO.MINERALSENERGY.2.3 | kind: subsection | parent: X.GEO.MINERALSENERGY.2 | pages: 62–63 | catalog: X.GEO.CF.NON_FERROUS_MINERALS
...
**Key terms (printed in bold)** · minerals; mine; Ferrous Minerals

**Figures and tables** · kind: caption (supporting evidence)
- p63: India: Distribution of Iron Ore, Manganese, Bauxite and Mica

### 2.3.1 Copper
unit: X.GEO.MINERALSENERGY.2.3.1 | kind: subsection | parent: X.GEO.MINERALSENERGY.2.3 | pages: 64 | catalog: X.GEO.CF.COPPER
...
**Key terms (printed in bold)** · mine; Mica

### 2.3.2 Bauxite
unit: X.GEO.MINERALSENERGY.2.3.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.2.3 | pages: 64–65 | catalog: X.GEO.CF.BAUXITE
...
**Key terms (printed in bold)** · deposits

#### Box
unit: X.GEO.MINERALSENERGY.2.3.2.box1 | kind: box | parent: X.GEO.MINERALSENERGY.2.3.2 | page: 64

Bauxite on the physical map of India.

**Dig a little deeper: Locate the mines of** · kind: activity (supporting evidence) · page 64
> 

**Figures and tables** · kind: caption (supporting evidence)
- p64: Fig. 5.4: Copper mines at Malanjkhand
- p64: Madhya Pradesh
- p64: Maharashtra
- p64: Others
- p64: 3%
...
- p64: 65% Jharkhand
- p64: 10%
- p64: Fig. 5.5: Production of Bauxite showing state-wise
- p64: share in per cent, 2018–19
- p64: Fig.5.6: Bauxite Mine

### 2.4 Non-Metallic Minerals
unit: X.GEO.MINERALSENERGY.2.4 | kind: subsection | parent: X.GEO.MINERALSENERGY.2 | pages: 65 | catalog: X.GEO.CF.NON_METALLIC_MINERALS
...
**Key terms (printed in bold)** · minerals; deposits; mine; Mica

### 2.5 Rock Minerals
unit: X.GEO.MINERALSENERGY.2.5 | kind: subsection | parent: X.GEO.MINERALSENERGY.2 | pages: 65–66 | catalog: X.GEO.CF.ROCK_MINERALS
...
**Key terms (printed in bold)** · material; Iron Ore; Limestone

#### Box: Hazards of Mining
unit: X.GEO.MINERALSENERGY.2.5.box1 | kind: box | parent: X.GEO.MINERALSENERGY.2.5 | page: 65 | catalog: X.GEO.CF.HAZARDS_MINING
...
**Dig a little deeper: Study the maps to explain why Chota Nagpur is a storehouse of minerals.** · kind: activity (supporting evidence) · page 65
> 

**Figures and tables** · kind: caption (supporting evidence)
- p65: Fig. 5.7: Production of Limestone showing
- p65: state-wise share in per cent, 2018–19
- p65: Fig. 5.8: Air pollution due to generation of dust in mining areas

## 3 Conservation of Minerals
unit: X.GEO.MINERALSENERGY.3 | kind: section | pages: 66–67 | catalog: X.GEO.CF.CONSERVATION_MINERALS
...
#### Box
unit: X.GEO.MINERALSENERGY.3.box1 | kind: box | parent: X.GEO.MINERALSENERGY.3 | page: 67

substitutes are being used instead of minerals.

**Dig a little deeper: Make a list of items where** · kind: activity (supporting evidence) · page 67
> 

**Activity** · kind: activity (supporting evidence) · page 67
> Where are these substitutes obtained from? Collect information about cross country natural gas pipelines laid by GAIL (India) under “One Nation One Grid”. Name some river valley projects and write the names of the dams built on these rivers.

## 4 Energy Resources
unit: X.GEO.MINERALSENERGY.4 | kind: section | pages: 67 | catalog: X.GEO.CF.ENERGY_RESOURCES
...
**Key terms (printed in bold)** · material; deposits; Lignite; bituminous; Anthracite; Electricity

**Figures and tables** · kind: caption (supporting evidence)
- p68: India: Distribution of Coal, Oil and Natural Gas

**CBSE map items linked to this unit** · Coal mine: Raniganj; Coal mine: Bokaro; Coal mine: Talcher (shown on the map only, not named in the text)

### 4.1.2 Petroleum
unit: X.GEO.MINERALSENERGY.4.1.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.1 | pages: 69 | catalog: X.GEO.CF.PETROLEUM

Petroleum or mineral oil is the next major energy source in India after coal. It provides fuel for heat and lighting, lubricants for machinery and raw materials for a number of manufacturing industries. Petroleum refineries act as a “nodal industry” for synthetic textile, fertiliser and numerous chemical industries. Most of the petroleum occurrences in India are associated with anticlines and fault traps in the rock formations of the tertiary age. In regions of folding, anticlines or domes, it occurs where oil is trapped in the crest of the upfold. The oil bearing layer is a porous limestone or sandstone through which oil may flow. The oil is prevented from rising or sinking by intervening non-porous layers. Petroleum is also found in fault traps between porous and non-porous rocks. Gas, being lighter usually occurs above the oil. Mumbai High, Gujarat and Assam are major petroleum production areas in India. From the map locate the 3 major off shore fields of western India. Ankeleshwar is the most important field of Gujarat. Assam is the oldest oil producing state of India. Digboi, Naharkatiya and Moran-Hugrijan are the important oil fields in the state.

**Key terms (printed in bold)** · layers; material; mine; Mica; Limestone; Coal

**CBSE map items linked to this unit** · Oil field: Digboi; Oil field: Naharkatia (shown on the map only, not named in the text); Oil field: Mumbai High; Oil field: Bassien (shown on the map only, not named in the text); Oil field: Kalol (shown on the map only, not named in the text); Oil field: Ankleshwar

### 4.1.3 Natural Gas
unit: X.GEO.MINERALSENERGY.4.1.3 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.1 | pages: 69 | catalog: X.GEO.CF.NATURAL_GAS

Natural Gas is found with petroleum deposits and is released when crude oil is brought to the surface. It can be used as a domestic and industrial fuel. It is used as fuel in power sector to generate electricity, for heating purpose in industries, as raw material in chemical, petrochemical and fertilizer industries, as transport fuel and as cooking fuel. With the expansion of gas infrastructure and local city gas distribution (COD) networks, natural gas is also emerging as a preferred transport fuel (CNG) and cooking fuel (PNG) at homes. India’s major gas reserves are found in the Mumbai High and allied fields along the west coast which are supplemented by finds in the Cambay basin. Along the East Coast, new reserves of natural gas have been discovered in the Krishna-Godavari basin. The first 1,700 km long Hazira-Vijaipur-Jagdishpur (HVJ) cross country gas pipeline, constructed by GAIL (India), linked Mumbai High and Bassein gas fields with various fertilizer, power and industrial complexes in western and northen India. This artery provided impetus to Indian gas market development. Overall, India’s gas infrastructure has expanded over ten times from 1,700 km to 18,500 km of cross-country pipelines and is expected to soon reach over 34, 000 km as Gas Grid by linking all gas sources and consuming markets across the country including North Eastern states.

**Key terms (printed in bold)** · material; deposits; Mica; Petroleum; Electricity

### 4.1.4 Electricity
unit: X.GEO.MINERALSENERGY.4.1.4 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.1 | pages: 69–71 | catalog: X.GEO.CF.ELECTRICITY
...
**Key terms (printed in bold)** · Coal; Petroleum; Natural Gas

**Activity** · kind: activity (supporting evidence) · page 71
> Collect information about thermal/hydel power plants located in your state. Show them on the map of India. Locate the 6 nuclear power stations and find out the state in which they are located. Collect information about newly established solar power plants in India.

**Figures and tables** · kind: caption (supporting evidence)
- p70: India: Distribution of Nuclear and Thermal Power Plants

**CBSE map items linked to this unit** · Thermal power plant: Namrup (shown on the map only, not named in the text); Thermal power plant: Singrauli (shown on the map only, not named in the text); Thermal power plant: Ramagundam

### 4.2 Non-Conventional Sources of Energy
unit: X.GEO.MINERALSENERGY.4.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.4 | pages: 71 | catalog: X.GEO.CF.NON_CONVENTIONAL_SOURCES_ENERGY
...
**Key terms (printed in bold)** · material; Energy Resources; Coal; Solar Energy

**Figures and tables** · kind: caption (supporting evidence)
- p71: Fig. 5.10: Solar operated electronic milk
- p71: testing equipment

### 4.2.1 Nuclear or Atomic Energy
unit: X.GEO.MINERALSENERGY.4.2.1 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 71 | catalog: X.GEO.CF.NUCLEAR_OR_ATOMIC_ENERGY
...
**CBSE map items linked to this unit** · Nuclear power plant: Narora (shown on the map only, not named in the text); Nuclear power plant: Kakrapara (shown on the map only, not named in the text); Nuclear power plant: Tarapur (shown on the map only, not named in the text); Nuclear power plant: Kalpakkam (shown on the map only, not named in the text)

### 4.2.2 Solar Energy
unit: X.GEO.MINERALSENERGY.4.2.2 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 71 | catalog: X.GEO.CF.SOLAR_ENERGY
...
**Key terms (printed in bold)** · Electricity

### 4.2.3 Wind Power
unit: X.GEO.MINERALSENERGY.4.2.3 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 71 | catalog: X.GEO.CF.WIND_POWER
...
**Figures and tables** · kind: caption (supporting evidence)
- p71: Fig. 5.11: Wind mills – Nagarcoil

### 4.2.4 Biogas
unit: X.GEO.MINERALSENERGY.4.2.4 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 72 | catalog: X.GEO.CF.BIOGAS
...
**Key terms (printed in bold)** · Coal

### 4.2.5 Tidal Energy
unit: X.GEO.MINERALSENERGY.4.2.5 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 72 | catalog: X.GEO.CF.TIDAL_ENERGY
...
### 4.2.6 Geo Thermal Energy
unit: X.GEO.MINERALSENERGY.4.2.6 | kind: subsection | parent: X.GEO.MINERALSENERGY.4.2 | pages: 72 | catalog: X.GEO.CF.GEO_THERMAL_ENERGY
...
unit: X.GEO.MINERALSENERGY.4.3 | kind: subsection | parent: X.GEO.MINERALSENERGY.4 | pages: 72 | catalog: X.GEO.CF.CONSERVATION_ENERGY_RESOURCES
...
**Key terms (printed in bold)** · Energy Resources; Conventional Sources of Energy; Electricity; Non-Conventional Sources of Energy

**Figures and tables** · kind: caption (supporting evidence)
- p72: Fig. 5.12: Biogas Plant

## Exercises
unit: X.GEO.MINERALSENERGY.EX | kind: exercise (never used as evidence) | pages: 72–74
...
(a) ferrous and non-ferrous minerals (b) conventional and non-conventional sources of energy (ii) What is a mineral? (iii) How are minerals formed in igneous and metamorphic rocks?
(iv) Why do we need to conserve mineral resources ?
3. Answer the following questions in about 120 words.
(i) Describe the distribution of coal in India. (ii) Why do you think that solar energy has a bright future in India?
ACTIVITY
Fill the name of the correct mineral in the crossword below:
M 2
o
ACROSS 1. A ferrous mineral (9) 2. Raw material for cement industry (9) 3. Finest iron ore with magnetic properties (9) 4. Highest quality hard coal (10) 5. Aluminium is obtained from this ore (7) 6. Khetri mines are famous for this mineral (6) 7. Formed due to evaporation (6)
DOWN 1. Found in placer deposit (4) 2. Iron ore mined in Bailadila (8) 3. Indispensable for electrical industry (4) 4. Geological Age of coal found in north east India (8) 5. Formed in veins and lodes (3)
