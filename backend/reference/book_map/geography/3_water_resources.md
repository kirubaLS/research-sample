# Water Resources
chapter: X.GEO.WATER | book: Contemporary India – II (Geography), Class X | edition: NCERT reprint 2026-27 | pages: 36–46
...
#### Box
unit: X.GEO.WATER.1.1.box1 | kind: box | parent: X.GEO.WATER.1.1 | page: 38
...
unit: X.GEO.WATER.2 | kind: section | pages: 38–40 | catalog: X.GEO.CF.MULTI_PURPOSE_RIVER_PROJECTS_INTEGRATED_WATER_RESOURCES_MANAGEMENT
...
**Activity** · kind: activity (supporting evidence) · page 39
> Find out more about any one traditional method of building dams and irrigation works.

**Activity** · kind: activity (supporting evidence) · page 40
> Collect information about floods occurred in different parts of the country due to heavy rainfall in recent times. Make a list of inter-state water disputes.

**Figures and tables** · kind: caption (supporting evidence)
- p38: Source: Annual Report, Ministry of Jal Shakti, Government of India 2022–23
- p39: Source: Dying Wisdom, CSE, 1997.
- p39: Fig. 3.2: Hirakud Dam
- p39: (This popular Bhadu song in the Damodar valley region narrates the troubles faced by people owing to the flooding of Damodar river known as the river of sorrow.)

**CBSE map items linked to this unit** · Dam: Salal (shown on the map only, not named in the text); Dam: Bhakra Nangal; Dam: Tehri; Dam: Rana Pratap Sagar (shown on the map only, not named in the text); Dam: Sardar Sarovar; Dam: Hirakud; Dam: Nagarjuna Sagar (shown on the map only, not named in the text); Dam: Tungabhadra (shown on the map only, not named in the text)

### 2.1 Sardar Sarovar Dam
unit: X.GEO.WATER.2.1 | kind: box | parent: X.GEO.WATER.2 | pages: 40–42 | catalog: X.GEO.CF.SARDAR_SAROVAR_DAM
review: The "Krishna-Godavari dispute" box is printed inside the running text here, not as a separate box. Its text is in this unit.
...
**Figures and tables** · kind: caption (supporting evidence)
- p40: Source: Sardar Sarovar Narmada Nigam Ltd. https://www.sardarsarovardam.org/
- p41: India: Major Rivers and Dams
- p42: Collect information about flood prone areas of the country

## 3 Rainwater Harvesting
unit: X.GEO.WATER.3 | kind: section | pages: 43–44 | catalog: X.GEO.CF.RAINWATER_HARVESTING
...
**Figures and tables** · kind: caption (supporting evidence)
- p43: (a) Recharge through Hand Pump
- p43: (b) Recharge through Abandoned Dugwell
- p43: • Rooftop rainwater is collected using a PVC pipe • Filtered using sand and bricks • Underground pipe takes water to sump for immediate usage • Excess water from the sump is taken to the well • Water from the well recharges the underground • Take water from the well (later)
- p43: Fig 3.3: Rooftop Rainwater Harvesting
- p43: Fig. 3.4
- p43: A kul leads to a circular village tank, as the above in the Kaza village, from which water is released as and when required.
- p43: Fig 3.5: Traditional method of rainwater
- p43: harvesting
...
#### Box: 1.
unit: X.GEO.WATER.4.box1 | kind: box | parent: X.GEO.WATER.4 | page: 45

Collect information on how industries are polluting our water resources. 2. Enact with your classmates a scene of water dispute in your locality.

**Figures and tables** · kind: caption (supporting evidence)
- p45: Picture 1: Bamboo pipes are used to divert perennial springs on the hilltops to the lower reaches by gravity.
- p45: Picture 2 and 3: The channel sections, made of bamboo, divert water to the plant site where it is distributed into branches, again made and laid out with different forms of bamboo pipes. The flow of water into the pipes is controlled by manipulating the pipe positions.
- p45: Picture 4: If the pipes pass a road, they are taken high above the land.
- p45: Picture 5 and 6 Reduced channel sections and diversion units are used at the last stage of water application. The last channel section enables water to be dropped near the roots of the plant.
- p45: Fig 3.7

## Exercises
unit: X.GEO.WATER.EX | kind: exercise (never used as evidence) | pages: 46–46
