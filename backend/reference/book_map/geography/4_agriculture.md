# Agriculture
chapter: X.GEO.AGRICULTURE | book: Contemporary India – II (Geography), Class X | edition: NCERT reprint 2026-27 | pages: 47–58
...
## Introduction
unit: X.GEO.AGRICULTURE.0 | kind: intro | pages: 47 | catalog: X.GEO.CF.AGRICULTURE_INTRODUCTION
...
> Can you name some industries based on agricultural raw material? Can you name some such types of farmings?

## 1 Types of Farming
unit: X.GEO.AGRICULTURE.1 | kind: section | pages: 47 | catalog: X.GEO.CF.TYPES_FARMING
...
**Activity** · kind: activity (supporting evidence) · page 48
> Can you name the type of farming Rinjha’s family is engaged in? Can you enlist some crops which are grown in such farming? Can you name some of the states of India where such farming is practised? Can you give some more examples of crops which may be commercial in one region and may provide subsistence in another region?

**Figures and tables** · kind: caption (supporting evidence)
- p47: Fig. 4.1

### 1.2 Intensive Subsistence Farming
unit: X.GEO.AGRICULTURE.1.2 | kind: subsection | parent: X.GEO.AGRICULTURE.1 | pages: 48 | catalog: X.GEO.CF.INTENSIVE_SUBSISTENCE_FARMING
...
**Figures and tables** · kind: caption (supporting evidence)
- p48: Fig. 4.2: Banana plantation in Southern
- p48: part of India

### 1.3 Commercial Farming
unit: X.GEO.AGRICULTURE.1.3 | kind: subsection | parent: X.GEO.AGRICULTURE.1 | pages: 48 | catalog: X.GEO.CF.COMMERCIAL_FARMING
...
**Key terms (printed in bold)** · Rice

**Figures and tables** · kind: caption (supporting evidence)
- p48: Fig. 4.3: Bamboo plantation in North-east

## 2 Cropping Pattern
unit: X.GEO.AGRICULTURE.2 | kind: section | pages: 49 | catalog: X.GEO.CF.CROPPING_PATTERN
...
**Key terms (printed in bold)** · rabi; kharif; zaid; Zaid; Rice; Wheat; Maize

### 2.1 Major Crops
unit: X.GEO.AGRICULTURE.2.1 | kind: subsection | parent: X.GEO.AGRICULTURE.2 | pages: 49 | catalog: X.GEO.CF.MAJOR_CROPS
...
**Key terms (printed in bold)** · Rice; Wheat; Millets

### 2.1.1 Rice
unit: X.GEO.AGRICULTURE.2.1.1 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 49–51 | catalog: X.GEO.CF.RICE
...
**Key terms (printed in bold)** · kharif

**Figures and tables** · kind: caption (supporting evidence)
- p49: Fig. 4.4 (a): Rice Cultivation
- p49: Fig. 4.4 (b): Rice is ready to be harvested in the
- p49: field
- p50: India: Distribution of Rice

**CBSE map items linked to this unit** · Major areas of rice (shown on the map only, not named in the text)

### 2.1.2 Wheat
unit: X.GEO.AGRICULTURE.2.1.2 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 51 | catalog: X.GEO.CF.WHEAT
...
**Key terms (printed in bold)** · rabi

**Figures and tables** · kind: caption (supporting evidence)
- p51: Fig. 4.6: Bajra Cultivation

**CBSE map items linked to this unit** · Major areas of wheat (shown on the map only, not named in the text)

### 2.1.3 Millets
unit: X.GEO.AGRICULTURE.2.1.3 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 51 | catalog: X.GEO.CF.MILLETS
...
### 2.1.4 Maize
unit: X.GEO.AGRICULTURE.2.1.4 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 51–52 | catalog: X.GEO.CF.MAIZE
...
**Key terms (printed in bold)** · rabi; kharif

**Figures and tables** · kind: caption (supporting evidence)
- p51: Fig. 4.5: Wheat Cultivation
- p51: Fig. 4.7: Maize Cultivation
- p52: India: Distribution of Wheat

### 2.1.5 Pulses
unit: X.GEO.AGRICULTURE.2.1.5 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 53–54 | catalog: X.GEO.CF.PULSES
...
**Figures and tables** · kind: caption (supporting evidence)
- p53: Fig. 4.8: Sugarcane Cultivation
- p53: Fig. 4.9: Groundnut, sunflower and mustard are ready to be harvested in the field
- p54: Fig. 4.10: Tea Cultivation
- p54: Fig. 4.11: Tea-leaves Harvesting

### 2.1.6 Food Crops other than Grains
unit: X.GEO.AGRICULTURE.2.1.6 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 54 | catalog: X.GEO.CF.FOOD_CROPS_OTHER_THAN_GRAINS

### 2.1.6.1 Sugarcane
unit: X.GEO.AGRICULTURE.2.1.6.1 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.6 | pages: 54 | catalog: X.GEO.CF.SUGARCANE
...
**CBSE map items linked to this unit** · Largest / major producer states of sugarcane (shown on the map only, not named in the text)

### 2.1.6.2 Oil Seeds
unit: X.GEO.AGRICULTURE.2.1.6.2 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.6 | pages: 54 | catalog: X.GEO.CF.OIL_SEEDS
...
### 2.1.6.3 Tea
unit: X.GEO.AGRICULTURE.2.1.6.3 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.6 | pages: 54 | catalog: X.GEO.CF.TEA
...
**CBSE map items linked to this unit** · Largest / major producer states of tea (shown on the map only, not named in the text)

### 2.1.6.4 Coffee
unit: X.GEO.AGRICULTURE.2.1.6.4 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.6 | pages: 54 | catalog: X.GEO.CF.COFFEE
...
**CBSE map items linked to this unit** · Largest / major producer states of coffee (shown on the map only, not named in the text)

### 2.1.6.5 Horticulture Crops
unit: X.GEO.AGRICULTURE.2.1.6.5 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.6 | pages: 54–55 | catalog: X.GEO.CF.HORTICULTURE_CROPS
...
**Figures and tables** · kind: caption (supporting evidence)
- p54: Fig. 4.12: Apricots, apple and pomegranate
- p54: Fig. 4.13: ig. 4.13: Cultivation of vegetables – peas, cauliflower, tomato and brinjal
- p54: Source: Pocket book of agricultural statistics, 2022, Govt. of India. Directorate of Economics and Statistics.

### 2.1.7 Non-Food Crops
unit: X.GEO.AGRICULTURE.2.1.7 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1 | pages: 55 | catalog: X.GEO.CF.NON_FOOD_CROPS
...
### 2.1.7.1 Rubber
unit: X.GEO.AGRICULTURE.2.1.7.1 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.7 | pages: 55 | catalog: X.GEO.CF.RUBBER
...
**CBSE map items linked to this unit** · Largest / major producer states of rubber (shown on the map only, not named in the text)

### 2.1.7.2 Fibre Crops
unit: X.GEO.AGRICULTURE.2.1.7.2 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.7 | pages: 55 | catalog: X.GEO.CF.FIBRE_CROPS

Cotton, jute, hemp and natural silk are the four major fibre crops grown in India. The first three are derived from the crops grown in the soil, the latter is obtained from cocoons of the silkworms fed on green leaves specially mulberry. Rearing of silk worms for the production of silk fibre is known as sericulture sericulture.

### 2.1.7.2.1 Cotton
unit: X.GEO.AGRICULTURE.2.1.7.2.1 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.7.2 | pages: 55 | catalog: X.GEO.CF.COTTON

India is believed to be the original home of the cotton plant. Cotton is one of the main raw materials for cotton textile industry. India is second largest producer of cotton after China. Cotton grows well in drier parts of the black cotton soil of the Deccan plateau. It requires high temperature, light rainfall or irrigation, 210 frost-free days and bright sun-shine for its growth. It is a kharif crop and requires 6 to 8 months to mature. Major cotton-producing states are–

Maharashtra, Gujarat, Madhya Pradesh, Karnataka, Andhra Pradesh, Telangana, Tamil Nadu, Punjab, Haryana and Uttar Pradesh.

**Key terms (printed in bold)** · kharif

**CBSE map items linked to this unit** · Largest / major producer states of cotton (shown on the map only, not named in the text)

### 2.1.7.2.2 Jute
unit: X.GEO.AGRICULTURE.2.1.7.2.2 | kind: subsection | parent: X.GEO.AGRICULTURE.2.1.7.2 | pages: 55 | catalog: X.GEO.CF.JUTE
...
**Figures and tables** · kind: caption (supporting evidence)
- p56: Fig. 4.15: Modern technological equipments used in agriculture

## Exercises
unit: X.GEO.AGRICULTURE.EX | kind: exercise (never used as evidence) | pages: 57–58
