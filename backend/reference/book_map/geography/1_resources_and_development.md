...
chapter: X.GEO.RESOURCES | book: Contemporary India – II (Geography), Class X | edition: NCERT reprint 2026-27 | pages: 18–29
...
The process of transformation of things available in our environment involves an interactive relationship between nature, technology and institutions. Human beings interact with nature through technology and create institutions to accelerate their economic development. Do you think that resources are free gifts of nature as is assumed by many? They are not. Resources are a function of human activities. Human beings themselves are essential components of resources. They transform material available in our environment into resources and use them. These resources can be classified in the following ways– (a) On the basis of origin – biotic and abiotic (b) On the basis of exhaustibility – renewable and non-renewable (c) On the basis of ownership – individual, community, national and international (d) On the basis of status of development – potential, developed stock and reserves.

**Activity** · kind: activity (supporting evidence) · page 18
...
- p18: Fig. 1.1: Interdependent relationship between
- p18: nature, technology and institutions
- p18: Fig. 1.2: Classification of resources

## 1 Development of Resources
unit: X.GEO.RESOURCES.1 | kind: section | pages: 19–20 | catalog: X.GEO.CF.DEVELOPMENT_RESOURCES
...
#### Box: 1.
unit: X.GEO.RESOURCES.1.box1 | kind: box | parent: X.GEO.RESOURCES.1 | page: 19

Imagine, if the oil supply gets exhausted one day, how would this affect our life style? 2. Plan a survey in your colony/village to investigate people’s attitude towards recycling of the domestic/agricultural wastes. Ask questions about: (a) What do they think about resources they use? (b) What is their opinion about the wastes, and its utilisation? (c) Collage your results.

#### Box: Sustainable development
unit: X.GEO.RESOURCES.1.box2 | kind: box | parent: X.GEO.RESOURCES.1 | page: 19 | catalog: X.GEO.CF.SUSTAINABLE_DEVELOPMENT
...
#### Box: Rio de Janeiro Earth Summit, 1992
unit: X.GEO.RESOURCES.1.box3 | kind: box | parent: X.GEO.RESOURCES.1 | page: 19 | catalog: X.GEO.CF.RIO_DE_JANEIRO_EARTH_SUMMIT_1992
...
#### Box: Agenda 21
unit: X.GEO.RESOURCES.1.box4 | kind: box | parent: X.GEO.RESOURCES.1 | page: 19 | catalog: X.GEO.CF.AGENDA_21
...
**Activity** · kind: activity (supporting evidence) · page 20
> Prepare a list of resources found in your state and also identify the resources that are important but deficit in your state. What resources are being developed in your surroundings by the community/village panchayats/ward level communities with the help of community participation? Can you name some resource rich but economically backward regions and some resource poor but economically developed regions? Give reasons for such a situation.

## 2 Resource Planning
unit: X.GEO.RESOURCES.2 | kind: section | pages: 20 | catalog: X.GEO.CF.RESOURCE_PLANNING
...
### 2.1 Resource Planning in India
unit: X.GEO.RESOURCES.2.1 | kind: subsection | parent: X.GEO.RESOURCES.2 | pages: 20–21 | catalog: X.GEO.CF.RESOURCE_PLANNING_IN_INDIA
...
## 3 Land Resources
unit: X.GEO.RESOURCES.3 | kind: section | pages: 21 | catalog: X.GEO.CF.LAND_RESOURCES
...
## 4 Land Utilisation
unit: X.GEO.RESOURCES.4 | kind: section | pages: 21 | catalog: X.GEO.CF.LAND_UTILISATION
...
unit: X.GEO.RESOURCES.5 | kind: section | pages: 21–23 | catalog: X.GEO.CF.LAND_USE_PATTERN_IN_INDIA
...
**Figures and tables** · kind: caption (supporting evidence)
- p21: Fig 1.3: India: Land under important Relief
- p21: Features
- p22: Reporting Area: 100 Per cent
- p22: 45.64%
- p22: Source: Directorate of Economics and Statistics, Ministry of Agriculture and Farmers Welfare,
- p22: Government of India, 2023
- p22: Fig. 1.4
- p22: 23.41%
- p22: 5.40%
- p22: 9.06%
...
unit: X.GEO.RESOURCES.6 | kind: section | pages: 23 | catalog: X.GEO.CF.LAND_DEGRADATION_CONSERVATION_MEASURES
...
Substratum weathered parent

rock material

Unweathered parent bed rock soil are equally important. Soil also consists of organic (humus) and inorganic materials (Fig. 1.5). On the basis of the factors responsible for soil formation, colour, thickness, texture, age, chemical and physical properties, the soils of India are classified in different types.

**Key terms (printed in bold)** · Top soil; the upper soil layer; Subsoil weathered; rocks sand and; silt clay; Substratum; weathered parent; rock material; Unweathered; parent bed rock

**Figures and tables** · kind: caption (supporting evidence)
- p23: Fig. 1.5: Soil Profile

### 7.1 Classification of Soils
unit: X.GEO.RESOURCES.7.1 | kind: subsection | parent: X.GEO.RESOURCES.7 | pages: 24 | catalog: X.GEO.CF.CLASSIFICATION_SOILS
...
unit: X.GEO.RESOURCES.7.1.1 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 24 | catalog: X.GEO.CF.ALLUVIAL_SOILS
...
**Key terms (printed in bold)** · Duars, Chos; Terai; Bangar; Khadar; bangar

**CBSE map items linked to this unit** · Major soil type: Alluvial soil (shown on the map only, not named in the text)

### 7.1.2 Black Soil
unit: X.GEO.RESOURCES.7.1.2 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 24–26 | catalog: X.GEO.CF.BLACK_SOIL
...
**Key terms (printed in bold)** · rock material

**Figures and tables** · kind: caption (supporting evidence)
- p24: Fig. 1.6: Alluvial Soil
- p24: Fig. 1.7: Black Soil
- p25: India: Major Soil Types

**CBSE map items linked to this unit** · Major soil type: Black soil (shown on the map only, not named in the text)

### 7.1.3 Red and Yellow Soils
unit: X.GEO.RESOURCES.7.1.3 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 26 | catalog: X.GEO.CF.RED_YELLOW_SOILS
...
**CBSE map items linked to this unit** · Major soil type: Red and yellow soil (shown on the map only, not named in the text)

### 7.1.4 Laterite Soil
unit: X.GEO.RESOURCES.7.1.4 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 26 | catalog: X.GEO.CF.LATERITE_SOIL
...
**Key terms (printed in bold)** · erosion

**CBSE map items linked to this unit** · Major soil type: Laterite soil (shown on the map only, not named in the text)

### 7.1.5 Arid Soils
unit: X.GEO.RESOURCES.7.1.5 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 26 | catalog: X.GEO.CF.ARID_SOILS
...
**Figures and tables** · kind: caption (supporting evidence)
- p26: Fig. 1.8: Laterite Soil
- p26: Fig. 1.9: Arid Soil

**CBSE map items linked to this unit** · Major soil type: Arid soil (shown on the map only, not named in the text)

### 7.1.6 Forest Soils
unit: X.GEO.RESOURCES.7.1.6 | kind: subsection | parent: X.GEO.RESOURCES.7.1 | pages: 27 | catalog: X.GEO.CF.FOREST_SOILS
...
**CBSE map items linked to this unit** · Major soil type: Forest soil (shown on the map only, not named in the text)

### 7.2 Soil Erosion and Soil Conservation
unit: X.GEO.RESOURCES.7.2 | kind: subsection | parent: X.GEO.RESOURCES.7 | pages: 27 | catalog: X.GEO.CF.SOIL_EROSION_SOIL_CONSERVATION
...
**Key terms (printed in bold)** · Top soil; gullies; bad land; sheet; erosion

**Figures and tables** · kind: caption (supporting evidence)
- p27: Fig. 1.10: Soil Erosion
- p27: Fig. 1.11: Gully Erosion

## Exercises
unit: X.GEO.RESOURCES.EX | kind: exercise (never used as evidence) | pages: 28–29
