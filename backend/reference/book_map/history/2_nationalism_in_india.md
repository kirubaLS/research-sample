...
chapter: X.HIST.NATIONALISM_INDIA | book: India and the Contemporary World – II (History), Class X | edition: NCERT reprint 2026-27 | pages: 41–62
...
- p41: Fig. 1 – 6 April 1919. Mass processions on the streets became a common feature during the national movement.

## 1 The First World War, Khilafat and Non-Cooperation
unit: X.HIST.NATIONALISM_INDIA.1 | kind: section | pages: 42 | catalog: X.HIST.CF.FIRST_WORLD_WAR_KHILAFAT_NON_COOPERATION
...
unit: X.HIST.NATIONALISM_INDIA.1.1 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.1 | pages: 42–43 | catalog: X.HIST.CF.IDEA_SATYAGRAHA
...
**Source A – Mahatma Gandhi on Satyagraha** · kind: source · page 43
...
**Activity** · kind: activity (supporting evidence) · page 43
> Read the text carefully. What did Mahatma Gandhi mean when he said satyagraha is active resistance?

**Figures and tables** · kind: caption (supporting evidence)
- p42: Fig. 2 – Indian workers in South Africa march through Volksrust, 6 November 1913. Mahatma Gandhi was leading the workers from Newcastle to Transvaal. When the marchers were stopped and Gandhiji arrested, thousands of more workers joined the satyagraha against racist laws that denied rights to non-whites.

**CBSE map items linked to this unit** · Satyagraha: Kheda (Peasant Satyagraha); Satyagraha: Champaran (Indigo planters); Satyagraha: Ahmedabad (Cotton mill workers)

### 1.2 The Rowlatt Act
unit: X.HIST.NATIONALISM_INDIA.1.2 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.1 | pages: 43–44 | catalog: X.HIST.CF.ROWLATT_ACT
...
**Figures and tables** · kind: caption (supporting evidence)
- p44: Fig. 3 – General Dyer’s ‘crawling orders’ being administered by British soldiers, Amritsar, Punjab, 1919.

**CBSE map items linked to this unit** · Jallianwala Bagh incident

### 1.3 Why Non-cooperation?
unit: X.HIST.NATIONALISM_INDIA.1.3 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.1 | pages: 44–45 | catalog: X.HIST.CF.WHY_NON_COOPERATION
...
**Figures and tables** · kind: caption (supporting evidence)
- p45: Fig. 4 – The boycott of foreign cloth, July 1922. Foreign cloth was seen as the symbol of Western economic and cultural domination.

**CBSE map items linked to this unit** · Indian National Congress session, Calcutta (September 1920); Indian National Congress session, Nagpur (December 1920)

## 2 Differing Strands within the Movement
unit: X.HIST.NATIONALISM_INDIA.2 | kind: section | pages: 46 | catalog: X.HIST.CF.DIFFERING_STRANDS_WITHIN_MOVEMENT
...
unit: X.HIST.NATIONALISM_INDIA.2.1 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.2 | pages: 46 | catalog: X.HIST.CF.MOVEMENT_IN_TOWNS
...
unit: X.HIST.NATIONALISM_INDIA.2.2 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.2 | pages: 46–48 | catalog: X.HIST.CF.REBELLION_IN_COUNTRYSIDE
...
**Figures and tables** · kind: caption (supporting evidence)
- p49: Fig. 5 – Chauri Chaura, 1922. At Chauri Chaura in Gorakhpur, a peaceful demonstration in a bazaar turned into a violent clash with the police. Hearing of the incident, Mahatma Gandhi called a halt to the Non-Cooperation Movement.

## 3 Towards Civil Disobedience
unit: X.HIST.NATIONALISM_INDIA.3 | kind: section | pages: 50–51 | catalog: X.HIST.CF.TOWARDS_CIVIL_DISOBEDIENCE
...
**Note (unlabelled margin text)** · kind: source · page 50
...
**Source C – The Independence Day Pledge, 26 January 1930** · kind: source · page 51
...
**Figures and tables** · kind: caption (supporting evidence)
- p50: Fig. 6 – Meeting of Congress leaders at Allahabad, 1931. Apart from Mahatma Gandhi, you can see Sardar Vallabhbhai Patel (extreme left), Jawaharlal Nehru (extreme right) and Subhas Chandra Bose (fifth from right).

### 3.1 The Salt March and the Civil Disobedience Movement
unit: X.HIST.NATIONALISM_INDIA.3.1 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.3 | pages: 51–53 | catalog: X.HIST.CF.SALT_MARCH_CIVIL_DISOBEDIENCE_MOVEMENT
review: Box 1 ("To the altar of this revolution…") sits beside the 3.1/3.2 boundary. Kept in 3.1; confirm.
...
#### Box 1: ‘To the altar of this revolution we have brought our youth as incense’
unit: X.HIST.NATIONALISM_INDIA.3.1.box1 | kind: box | parent: X.HIST.NATIONALISM_INDIA.3.1 | page: 53
...
**Figures and tables** · kind: caption (supporting evidence)
- p52: Fig. 7 – The Dandi march. During the salt march Mahatma Gandhi was accompanied by 78 volunteers. On the way they were joined by thousands.
- p52: Fig. 8 – Police cracked down on satyagrahis, 1930.

**CBSE map items linked to this unit** · Dandi March

### 3.2 How Participants saw the Movement
unit: X.HIST.NATIONALISM_INDIA.3.2 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.3 | pages: 53–55 | catalog: X.HIST.CF.HOW_PARTICIPANTS_SAW_MOVEMENT
...
**Discuss** · kind: activity (supporting evidence) · page 55
> Why did various classes and groups of Indians participate in the Civil Disobedience Movement?

**Figures and tables** · kind: caption (supporting evidence)
- p55: Fig. 9 – Women join nationalist processions. During the national movement, many women, for the first time in their lives, moved out of their homes on to a public arena. Amongst the marchers you can see many old women, and mothers with children in their arms.

### 3.3 The Limits of Civil Disobedience
unit: X.HIST.NATIONALISM_INDIA.3.3 | kind: subsection | parent: X.HIST.NATIONALISM_INDIA.3 | pages: 55–57 | catalog: X.HIST.CF.LIMITS_CIVIL_DISOBEDIENCE
...
**Discuss** · kind: activity (supporting evidence) · page 57
> Read the Source D carefully. Do you agree with Iqbal’s idea of communalism? Can you define communalism in a different way?

**Figures and tables** · kind: caption (supporting evidence)
- p56: Fig. 10 – Mahatma Gandhi, Jawaharlal Nehru and Maulana Azad at Sevagram Ashram, Wardha, 1935.

## 4 The Sense of Collective Belonging
unit: X.HIST.NATIONALISM_INDIA.4 | kind: section | pages: 58–60 | catalog: X.HIST.CF.SENSE_COLLECTIVE_BELONGING
...
**Figures and tables** · kind: caption (supporting evidence)
- p58: Fig. 11 – Bal Gangadhar Tilak, an early-twentieth-century print. Notice how Tilak is surrounded by symbols of unity. The sacred institutions of different faiths (temple, church, masjid) frame the central figure.
- p59: Fig. 13 – Jawaharlal Nehru, a popular print. Nehru is here shown holding the image of Bharat Mata and the map of India close to his heart. In a lot of popular prints, nationalist leaders are shown offering their heads to Bharat Mata. The idea of sacrifice for the mother was powerful within popular imagination.
- p59: Fig. 12 – Bharat Mata, Abanindranath Tagore, 1905. Notice that the mother figure here is shown as dispensing learning, food and clothing. The mala in one hand emphasises her ascetic quality. Abanindranath Tagore, like Ravi Varma before him, tried to develop a style of painting that could be seen as truly Indian.
- p60: Fig. 14a – Bharat Mata. This figure of Bharat Mata is a contrast to the one painted by Abanindranath Tagore. Here she is shown with a trishul, standing beside a lion and an elephant – both symbols of power and authority.

## Conclusion
unit: X.HIST.NATIONALISM_INDIA.CONCLUSION | kind: summary | pages: 61 | catalog: X.HIST.CF.CONCLUSION
...
#### Box: Quit India Movement
unit: X.HIST.NATIONALISM_INDIA.CONCLUSION.box1 | kind: box | parent: X.HIST.NATIONALISM_INDIA.CONCLUSION | page: 61
...
**Figures and tables** · kind: caption (supporting evidence)
- p61: Fig. 14b Women’s procession in Bombay during the Quit India Movement

## Exercises
unit: X.HIST.NATIONALISM_INDIA.EX | kind: exercise (never used as evidence) | pages: 62–62

Write in brief
1. Explain: a) Why growth of nationalism in the colonies is linked to an anti-colonial movement. b) How the First World War helped in the growth of the National Movement in India. c) Why Indians were outraged by the Rowlatt Act. d) Why Gandhiji decided to withdraw the Non-Cooperation Movement.
