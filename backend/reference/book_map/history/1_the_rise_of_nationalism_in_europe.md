...
chapter: X.HIST.NATIONALISM_EUROPE | book: India and the Contemporary World – II (History), Class X | edition: NCERT reprint 2026-27 | pages: 15–40
...
## Introduction
unit: X.HIST.NATIONALISM_EUROPE.0 | kind: intro | pages: 15–16 | catalog: X.HIST.CF.INTRODUCTION
...
**Source A – Ernst Renan, ‘What is a Nation?’** · kind: source · page 16
...
**Activity** · kind: activity (supporting evidence) · page 15
> In what way do you think this print (Fig. 1) depicts a utopian vision?

**Discuss** · kind: activity (supporting evidence) · page 16
...
- p15: Fig. 1 — The Dream of Worldwide Democratic and Social Republics – The Pact Between Nations, a print prepared by Frédéric Sorrieu, 1848.

## 1 The French Revolution and the Idea of the Nation
unit: X.HIST.NATIONALISM_EUROPE.1 | kind: section | pages: 17–19 | catalog: X.HIST.CF.FRENCH_REVOLUTION_IDEA_NATION
...
**Figures and tables** · kind: caption (supporting evidence)
- p17: Fig. 2 — The cover of a German almanac designed by the journalist Andreas Rebmann in 1798. The image of the French Bastille being stormed by the revolutionary crowd has been placed next to a similar fortress meant to represent the bastion of despotic rule in the German province of Kassel. Accompanying the illustration is the slogan: ‘The people must seize their own freedom!’ Rebmann lived in the city of Mainz and was a member of a German Jacobin group.
- p18: Fig. 3 — Europe after the Congress of Vienna, 1815.
- p19: Fig. 4 — The Planting of Tree of Liberty in Zweibrücken, Germany. The subject of this colour print by the German painter Karl Kaspar Fritz is the occupation of the town of Zweibrücken by the French armies. French soldiers, recognisable by their blue, white and red uniforms, have been portrayed as oppressors as they seize a peasant’s cart (left), harass some young women (centre foreground) and force a peasant down to his knees. The plaque being affixed to the Tree of Liberty carries a German inscription which in translation reads: ‘Take freedom and equality from us, the model of humanity.’ This is a sarcastic reference to the claim of the French as being liberators who opposed monarchy in the territories they entered.
- p19: Fig. 5 — The courier of Rhineland loses all that he has on his way home from Leipzig. Napoleon here is represented as a postman on his way back to France after he lost the battle of Leipzig in 1813. Each letter dropping out of his bag bears the names of the territories he lost.

## 2 The Making of Nationalism in Europe
unit: X.HIST.NATIONALISM_EUROPE.2 | kind: section | pages: 20 | catalog: X.HIST.CF.MAKING_NATIONALISM_IN_EUROPE
...
unit: X.HIST.NATIONALISM_EUROPE.2.2 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.2 | pages: 21–22 | catalog: X.HIST.CF.WHAT_DID_LIBERAL_NATIONALISM_STAND_FOR
...
**Discuss** · kind: activity (supporting evidence) · page 22
> Describe the political ends that List hopes to achieve through economic measures.

### 2.3 A New Conservatism after 1815
unit: X.HIST.NATIONALISM_EUROPE.2.3 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.2 | pages: 22–24 | catalog: X.HIST.CF.NEW_CONSERVATISM_AFTER_1815
...
**Activity** · kind: activity (supporting evidence) · page 23
> Plot on a map of Europe the changes drawn up by the Vienna Congress. What is the caricaturist trying to depict? Discuss

**Figures and tables** · kind: caption (supporting evidence)
- p23: Fig. 6 — The Club of Thinkers, anonymous caricature dating to c. 1820. The plaque on the left bears the inscription: ‘The most important question of today’s meeting: How long will thinking be allowed to us?’ The board on the right lists the rules of the Club which include the following: ‘1. Silence is the first commandment of this learned society. 2. To avoid the eventuality whereby a member of this club may succumb to the temptation of speech, muzzles will be distributed to members upon entering.’

### 2.4 The Revolutionaries
unit: X.HIST.NATIONALISM_EUROPE.2.4 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.2 | pages: 24 | catalog: X.HIST.CF.REVOLUTIONARIES
...
**Figures and tables** · kind: caption (supporting evidence)
- p24: Fig. 7 — Giuseppe Mazzini and the founding of Young Europe in Berne 1833. Print by Giacomo Mantegazza.

## 3 The Age of Revolutions: 1830-1848
unit: X.HIST.NATIONALISM_EUROPE.3 | kind: section | pages: 25 | catalog: X.HIST.CF.AGE_REVOLUTIONS_1830_1848
...
unit: X.HIST.NATIONALISM_EUROPE.3.1 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.3 | pages: 25–27 | catalog: X.HIST.CF.ROMANTIC_IMAGINATION_NATIONAL_FEELING
...
unit: X.HIST.NATIONALISM_EUROPE.3.1.box1 | kind: box | parent: X.HIST.NATIONALISM_EUROPE.3.1 | page: 27
...
**Discuss** · kind: activity (supporting evidence) · page 28
> Describe the cause of the Silesian weavers’ uprising. Comment on the viewpoint of the journalist.

**Activity** · kind: activity (supporting evidence) · page 28
> Imagine you are a weaver who saw the events as they unfolded. Write a report on what you saw.

**Figures and tables** · kind: caption (supporting evidence)
- p28: Fig. 9 — Peasants’ uprising, 1848.

### 3.3 1848: The Revolution of the Liberals
unit: X.HIST.NATIONALISM_EUROPE.3.3 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.3 | pages: 29–30 | catalog: X.HIST.CF.1848_REVOLUTION_LIBERALS
...
**Source C – How were liberty and equality for women to be defined?** · kind: source · page 29
...
**Discuss** · kind: activity (supporting evidence) · page 30
...
**Figures and tables** · kind: caption (supporting evidence)
- p30: Fig. 10 — The Frankfurt parliament in the Church of St Paul. Contemporary colour print. Notice the women in the upper left gallery.

## 4 The Making of Germany and Italy
unit: X.HIST.NATIONALISM_EUROPE.4 | kind: section | pages: 31 | catalog: X.HIST.CF.MAKING_GERMANY_ITALY

### 4.1 Germany – Can the Army be the Architect of a Nation?
unit: X.HIST.NATIONALISM_EUROPE.4.1 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.4 | pages: 31–32 | catalog: X.HIST.CF.GERMANY_CAN_ARMY_BE_ARCHITECT_NATION
...
- p32: Fig. 12 — Unification of Germany (1866-71).

### 4.2 Italy Unified
unit: X.HIST.NATIONALISM_EUROPE.4.2 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.4 | pages: 32–34 | catalog: X.HIST.CF.ITALY_UNIFIED
review: Box 2 (Garibaldi) moved here from 4.3; it is printed after the 4.3 heading only because of page layout.
...
#### Box 2
unit: X.HIST.NATIONALISM_EUROPE.4.2.box1 | kind: box | parent: X.HIST.NATIONALISM_EUROPE.4.2 | page: 34
...
**Activity** · kind: activity (supporting evidence) · page 32
...
**Figures and tables** · kind: caption (supporting evidence)
- p32: Fig. 13 — Caricature of Otto von Bismarck in the German reichstag (parliament), from Figaro, Vienna, 5 March 1870.
- p33: Fig. 14(a) — Italian states before unification, 1858.
- p33: Fig. 14(b) — Italy after unification. The map shows the year in which different regions (seen in Fig 14(a) become part of a unified Italy.

### 4.3 The Strange Case of Britain
unit: X.HIST.NATIONALISM_EUROPE.4.3 | kind: subsection | parent: X.HIST.NATIONALISM_EUROPE.4 | pages: 33–34 | catalog: X.HIST.CF.STRANGE_CASE_BRITAIN
...
**Activity** · kind: activity (supporting evidence) · page 34
...
**Figures and tables** · kind: caption (supporting evidence)
- p34: Fig. 15 – Garibaldi helping King Victor Emmanuel II of Sardinia-Piedmont to pull on the boot named ‘Italy’. English caricature of 1859.

## 5 Visualising the Nation
unit: X.HIST.NATIONALISM_EUROPE.5 | kind: section | pages: 35–37 | catalog: X.HIST.CF.VISUALISING_NATION
...
#### Box 3: Meanings of the symbols
unit: X.HIST.NATIONALISM_EUROPE.5.box1 | kind: box | parent: X.HIST.NATIONALISM_EUROPE.5 | page: 36
...
**Activity** · kind: activity (supporting evidence) · page 37
...
**Figures and tables** · kind: caption (supporting evidence)
- p35: Fig. 16 — Postage stamps of 1850 with the figure of Marianne representing the Republic of France.
- p35: Fig. 17 — Germania, Philip Veit, 1848. The artist prepared this painting of Germania on a cotton banner, as it was meant to hang from the ceiling of the Church of St Paul where the Frankfurt parliament was convened in March 1848.
- p36: Fig. 18 — The fallen Germania, Julius Hübner, 1850.
- p37: Fig. 19 — Germania guarding the Rhine. In 1860, the artist Lorenz Clasen was commissioned to paint this image. The inscription on Germania’s sword reads: ‘The German sword protects the German Rhine.’

## 6 Nationalism and Imperialism
unit: X.HIST.NATIONALISM_EUROPE.6 | kind: section | pages: 38–39 | catalog: X.HIST.CF.NATIONALISM_IMPERIALISM
...
## Exercises
unit: X.HIST.NATIONALISM_EUROPE.EX | kind: exercise (never used as evidence) | pages: 40–40
