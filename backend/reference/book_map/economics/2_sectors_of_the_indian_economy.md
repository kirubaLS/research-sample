...
chapter: X.ECO.SECTORS | book: Understanding Economic Development (Economics), Class X | edition: NCERT reprint 2026-27 | pages: 31–49
...
unit: X.ECO.SECTORS.1 | kind: section | pages: 31–33 | catalog: X.ECO.CF.SECTORS_ECONOMIC_ACTIVITIES
...
**Key terms (printed in bold)** · mainly, but not entirely; primary sector; agriculture and related; sector; secondary sector; industrial; tertiary sector; service sector; interdependent

**Activity** · kind: activity (supporting evidence) · page 33
...
**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 33
> 1. Complete the above table to show how sectors are dependent on each other. 2. Explain the difference between primary, secondary and tertiary sectors using examples other than those mentioned in the text. 3. Classify the following list of occupations under primary, secondary and tertiary sectors: • Workers in match factory • Moneylender • Gardener • Potter • Bee-keeper • Astronaut • Call centre employee 4. Students in a school are often classified into primary and secondary or junior and senior. What is the criterion that is used? Do you think this is a useful classification? Discuss. • Tailor • Basket weaver • Flower cultivator • Milk vendor • Fishermen • Priest • Courier This is an example of the secondary or industrial sector being dependent on the primary.

**Figures and tables** · kind: caption (supporting evidence)
- p32: Primary (Agriculture)
- p32: Sector
- p32: Tertiary (Service)
- p32: Sector
- p32: produces
- p32: natural
- p32: goods
- p32: helps to develop
- p32: Secondary
- p32: other sectors
- p32: (Industrial)
- p32: Sector
- p32: produces manufactured
- p32: goods
- p33: TABLE 2.1 EXAMPLES OF ECONOMIC ACTIVITIES
- p33: EXAMPLE
- p33: WHAT DOES THIS SHOW?

## 2 COMPARING THE THREE SECTORS
unit: X.ECO.SECTORS.2 | kind: section | pages: 34 | catalog: X.ECO.CF.COMPARING_THREE_SECTORS
...
### 2.1 How do we count the various goods and services and know the total production in each sector?
unit: X.ECO.SECTORS.2.1 | kind: subsection | parent: X.ECO.SECTORS.2 | pages: 34–35 | catalog: X.ECO.CF.HOW_DO_WE_COUNT_GOODS_SERVICES_TOTAL_PRODUCTION_EACH_SECTOR
...
The value of final goods and services produced in each sector during a particular year provides the total production of the sector for that year. And the sum of production in the different sectors gives what is called the Gross Domestic Pr Domestic Product (GDP) oduct (GDP) of a country. It is the value of all final goods and services produced within a country during a particular year. GDP shows how big the economy is.
...
**Key terms (printed in bold)** · final goods and services; already includes

**Figures and tables** · kind: caption (supporting evidence)
- p34: ...BUT I SHOULD BE PAID THE
- p34: FULL VALUE OF THE WHEAT
- p34: THAT I PRODUCE !
- p34: NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 22
- p34: U NDERST

### 2.2 Historical Change in Sectors
unit: X.ECO.SECTORS.2.2 | kind: subsection | parent: X.ECO.SECTORS.2 | pages: 35 | catalog: X.ECO.CF.HISTORICAL_CHANGE_IN_SECTORS
...
**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 35
> 1. What does the history of developed countries indicate about the shifts that have taken place between sectors? 2. Correct and arrange the important aspects for calculating GDP from this Jumble. 3. Discuss with your teacher how you could calculate the total value of a good or service by using the method of value added at each stage.

**Figures and tables** · kind: caption (supporting evidence)
- p35: To count goods and services we add the numbers that are produced. We count all those that were produced in the last five years. Since we shouldn’t leave out anything we add up all these goods and services.
- p35: ECTORS OF THE I NDIAN E CONOMY 23
- p35: S ECTORS

## 3 PRIMARY, SECONDARY AND TERTIARY SECTORS IN INDIA
unit: X.ECO.SECTORS.3 | kind: section | pages: 36 | catalog: X.ECO.CF.PRIMARY_SECONDARY_TERTIARY_SECTORS_IN_INDIA

What does the comparison between

1977–78 and 2017–18 show? What conclusions can we draw from the comparison?

Let’s find out.

**Activity** · kind: activity (supporting evidence) · page 36
> 14000000 12000000 10000000 8000000

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 36
> 6000000 Answer the following questions by looking at the graph: 4000000 1. Which was the largest producing sector in 1977–78? 2000000 2. Which is the largest producing sector in 2017–18? 3. Can you say which sector has grown the most over forty years? 4. What was the GDP of India in 2017–18? Tertiary Sectors 0 1977-78 2017-18

**Figures and tables** · kind: caption (supporting evidence)
- p36: Graph 1 shows the production of goods and services in the three sectors. This is shown for two years, 1977–78 and 2017–18. We have used the data for these two years because the data are comparable and authentic. You can see how the total production has grown over the forty years.
- p36: Graph 1: GVA by Primary, Secondary and
- p36: Rs. in crores

### 3.1 Rising Importance of the Tertiary Sector in Production
unit: X.ECO.SECTORS.3.1 | kind: subsection | parent: X.ECO.SECTORS.3 | pages: 36–37 | catalog: X.ECO.CF.RISING_IMPORTANCE_TERTIARY_SECTOR_IN_PRODUCTION
...
**Figures and tables** · kind: caption (supporting evidence)
- p36: NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 24
- p36: U NDERST
- p37: Graph 2: Share of Sectors in GVA
- p37: Graph 3: Share of Sectors in Employment (%)

### 3.2 Where are most of the people employed?
unit: X.ECO.SECTORS.3.2 | kind: subsection | parent: X.ECO.SECTORS.3 | pages: 37–39 | catalog: X.ECO.CF.WHERE_ARE_MOST_PEOPLE_EMPLOYED
...
**Key terms (printed in bold)** · underemployed; labour effort; This kind of; underemployment is hidden in; contrast to someone who does not; have a job and is clearly visible as; unemployed. Hence, it is also; called disguised unemployment; they may; spend the whole day but earn; very little

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 39
> 1. Complete the table using the data given in Graphs 2 and 3 and answer the question that follows. Ignore if data are not available for some years. Share in Gross Value Added (GVA) Share in employment What are the changes that you observe in the primary sector over a span of forty years? 2. Choose the correct answer: Underemployment occurs when people (i) do not want to work (ii) are working in a lazy manner (iii) are working less than what they are capable of doing (iv) are not paid for their work 3. Compare and contrast the changes in India with the pattern that was observed for developed countries. What kind of changes between sectors were desired but did not happen in India? 4. Why should we be worried about underemployment? 1977-78 2017-18

**Figures and tables** · kind: caption (supporting evidence)
- p37: Graph 2 presents percentage share of the three sectors in GVA. Now you can directly see the changing importance of the sectors over the forty years.
- p37: ECTORS OF THE I NDIAN E CONOMY 25
- p37: S ECTORS
- p38: NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 26
- p38: U NDERST
- p39: TABLE 2.2 SHARE OF PRIMARY SECTOR IN
- p39: GDP AND EMPLOYMENT

### 3.3 How to Create More Employment?
unit: X.ECO.SECTORS.3.3 | kind: subsection | parent: X.ECO.SECTORS.3 | pages: 39–41 | catalog: X.ECO.CF.HOW_TO_CREATE_MORE_EMPLOYMENT
...
**Key terms (printed in bold)** · organised; unorganised; sector

#### Box: Kanta
unit: X.ECO.SECTORS.4.box1 | kind: box | parent: X.ECO.SECTORS.4 | page: 42

Kanta works in an office. She attends her office from 9.30 a.m. to 5.30 p.m. She gets her salary regularly at the end of every month. In addition to the salary, she also gets provident fund as per the rules laid down by the government. She also gets medical and other allowances. Kanta does not go to office on Sundays. This is a paid holiday. When she joined work, she was given an appointment letter stating all the terms and conditions of work. Kamal is Kanta’s neighbour. He is a daily wage labourer in a nearby grocery shop. He goes to the shop at 7:30 in the morning and works till 8:00 p.m. in the evening. He gets no other allowances apart from his wages. He is not paid for the days he does not work. He has therefore no leave or paid holidays. Nor was he given any formal letter saying that he has been employed in the shop. He can be asked to leave anytime by his employer. Do you see the differences in the conditions of work between Kanta and Kamal ?

#### Box: Kamal
unit: X.ECO.SECTORS.4.box2 | kind: box | parent: X.ECO.SECTORS.4 | page: 42



**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 43
> 1. Look at the following examples. Which of these are unorganised sector activities? (i) A teacher taking classes in a school (ii) A headload worker carrying a bag of cement on his back in a market (iii) A farmer irrigating her field (iv) A doctor in a hospital treating a patient (v) A daily wage labourer working under a contractor (vi) A factory worker going to work in a big factory (vii) A handloom weaver working in her house 2. Talk to someone who has a regular job in the organised sector and another who works in the unorganised sector. Compare and contrast their working conditions in all aspects. 3. How would you distinguish between organised and unorganised sectors? Explain in your own words. 4. The table below shows the estimated number of workers in India in the organised and unorganised sectors in the late 1990s. Read the table carefully. Fill in the missing data and answer the questions that follow. Sector Organised Unorganised Total Primary 1 232 Secondary 41 74 115 Tertiary 40 88 128 Total 82 Total in Percentage 100% What is the percentage of people in the unorganised sector in agriculture? · Do you agree that agriculture is an unorganised sector activity? Why? · If we look at the country as a whole, we find that ———% of the workers in India are in the unorganised sector. Organised sector employment is available to only about ———% of the workers in India.

**Figures and tables** · kind: caption (supporting evidence)
- p43: TABLE 2.3 WORKERS IN DIFFERENT SECTORS (IN MILLIONS)
- p43: ·
- p43: ECTORS OF THE I NDIAN E CONOMY 31
- p43: S ECTORS

### 4.1 How to Protect Workers in the Unorganised Sector?
unit: X.ECO.SECTORS.4.1 | kind: subsection | parent: X.ECO.SECTORS.4 | pages: 44–45 | catalog: X.ECO.CF.HOW_TO_PROTECT_WORKERS_IN_UNORGANISED_SECTOR
...
#### Box
unit: X.ECO.SECTORS.4.1.box1 | kind: box | parent: X.ECO.SECTORS.4.1 | page: 44
...
**LET’S RECALL** · kind: activity (supporting evidence) · page 45
> Sector Criteria used Most important Problems indicated and conclusion how they can be tackled Primary, Nature Secondary, of activity Tertiary Organised, Unorganised

**Figures and tables** · kind: caption (supporting evidence)
- p45: TABLE 2.4 CLASSIFYING ECONOMIC ACTIVITIES

## 5 SECTORS IN TERMS OF OWNERSHIP: PUBLIC AND PRIVATE SECTORS
unit: X.ECO.SECTORS.5 | kind: section | pages: 45–46 | catalog: X.ECO.CF.SECTORS_IN_TERMS_OWNERSHIP_PUBLIC_PRIVATE_SECTORS
...
**Figures and tables** · kind: caption (supporting evidence)
- p46: NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 34
- p46: U NDERST

## Exercises
unit: X.ECO.SECTORS.EX | kind: exercise (never used as evidence) | pages: 47–49

1. Fill in the blanks using the correct option given in the bracket:
(i) Employment in the service sector ___ increased to the same extent
as production. (has / has not)
(ii) Workers in the ___ sector do not produce goods.
(tertiary / agricultural)
(iii) Most of the workers in the ___ sector enjoy job security.
(organised / unorganised)
(iv) A ___ proportion of labourers in India are working in the unorganised
sector. (large / small)
(v) Cotton is a ___ product and cloth is a ___ product.
...
activity in ___ sector.
(i) primary
(ii) secondary
(iii) tertiary
(iv) information technology
(c) GDP is the total value of ___ produced during a particular year.
...
(iii) 50 to 60
(iv) 60 to 70
ECTORS OF THE I NDIAN E CONOMY 35
S ECTORS
...
(i) Tourist guide, dhobi, tailor, potter, farmer (ii) Teacher, doctor, vegetable vendor, lawyer (iii) Postman, cobbler, soldier, police constable (iv) MTNL, Indian Railways, Air India, All India Radio
...
NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 36
U NDERST
NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT 36
U NDERST
...
ECTORS OF THE I NDIAN E CONOMY 37 S ECTORS OF THE I NDIAN E CONOMY 37
S ECTORS
