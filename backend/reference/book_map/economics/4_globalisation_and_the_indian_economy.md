...
chapter: X.ECO.GLOBALISATION | book: Understanding Economic Development (Economics), Class X | edition: NCERT reprint 2026-27 | pages: 67–85
...
## Introduction
unit: X.ECO.GLOBALISATION.0 | kind: intro | pages: 67 | catalog: X.ECO.CF.GLOBALISATION_INTRODUCTION
...
**Key terms (printed in bold)** · In a matter of years, our; markets have been transformed!

## 1 PRODUCTION ACROSS COUNTRIES
unit: X.ECO.GLOBALISATION.1 | kind: section | pages: 68–69 | catalog: X.ECO.CF.PRODUCTION_ACROSS_COUNTRIES
...
**Key terms (printed in bold)** · multinational corporations; the goods and; services are produced globally; production is organised in; increasingly complex ways

#### Box: Spreading of Production by an MNC
unit: X.ECO.GLOBALISATION.1.box1 | kind: box | parent: X.ECO.GLOBALISATION.1 | page: 68
...
**LET’S WORK THIS OUT** · kind: activity (supporting evidence) · page 69
...
- p69: The brand tag says ‘Made in Thailand’ but they are not Thai products. We dissect the manufacturing process and look for the best solution at each step. We are doing it globally. In making garments, the company may, for example, get cotton fibre from Korea,........

## 2 INTERLINKING PRODUCTION ACROSS COUNTRIES
unit: X.ECO.GLOBALISATION.2 | kind: section | pages: 69–71 | catalog: X.ECO.CF.INTERLINKING_PRODUCTION_ACROSS_COUNTRIES
...
#### Box
unit: X.ECO.GLOBALISATION.2.box3 | kind: box | parent: X.ECO.GLOBALISATION.2 | page: 71
...
> Read the passage on the left and answer the questions. LET’S WORK THESE OUT

**Activity** · kind: activity (supporting evidence) · page 71
> 1. Would you say Ford Motors is a MNC? Why? 2. What is foreign investment? How much did Ford Motors invest in India? 3. By setting up their production plants in India, MNCs such as Ford Motors tap the advantage not only of the large markets that countries such as India provide, but also the lower costs of production. Explain the statement. 4. Why do you think the company wants to develop India as a base for manufacturing car components for its global operations? Discuss the following factors: (a) cost of labour and other resources in India (b) the presence of several local manufacturers who supply auto- parts to Ford Motors (c) closeness to a large number of buyers in India and China 5. In what ways will the production of cars by Ford Motors in India lead to interlinking of production? 6. In what ways is a MNC different from other companies? 7. Nearly all major multinationals are American, Japanese or European, such as Nike, Coca-Cola, Pepsi, Honda, Nokia. Can you guess why?

**Figures and tables** · kind: caption (supporting evidence)
- p69: WE WILL SHIFT THIS FACTORY TO ANOTHER COUNTRY.
- p69: IT HAS BECOME EXPENSIVE HERE!

## 3 FOREIGN TRADE AND INTEGRATION OF MARKETS
unit: X.ECO.GLOBALISATION.3 | kind: section | pages: 71–73 | catalog: X.ECO.CF.FOREIGN_TRADE_INTEGRATION_MARKETS
...
**Key terms (printed in bold)** · Foreign trade thus results in; connecting the markets or; integration of markets in different; countries

#### Box: Chinese Toys in India
unit: X.ECO.GLOBALISATION.3.box1 | kind: box | parent: X.ECO.GLOBALISATION.3 | page: 72
...
#### Box
unit: X.ECO.GLOBALISATION.3.box2 | kind: box | parent: X.ECO.GLOBALISATION.3 | page: 73

Small traders of readymade garments facing stiff competition from both the MNC brands and imports.

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 73
> 1. What was the main channel connecting countries in the past? How is it different now? 2. Distinguish between foreign trade and foreign investment. 3. In recent years China has been importing steel from India. Explain how the import of steel by China will affect. (a) steel companies in China. (b) steel companies in India. (c) industries buying steel for production of other industrial goods in China. 4. How will the import of steel from India into the Chinese markets lead to integration of markets for steel in the two countries? Explain.

**Figures and tables** · kind: caption (supporting evidence)
- p71: OBALISA OBALISATION TION AND THE I NDIAN E CONOMY 59
- p71: G LOBALISA

## 4 WHAT IS GLOBALISATION?
unit: X.ECO.GLOBALISATION.4 | kind: section | pages: 73–74 | catalog: X.ECO.CF.WHAT_IS_GLOBALISATION
...
**Key terms (printed in bold)** · Globalisation is this; process of rapid integration or; interconnection between countries; More; and more goods and services; investments and technology are; moving between countries

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 74
> 1. What is the role of MNCs in the globalisation process? 2. What are the various ways in which countries can be linked? 3. Choose the correct option. Globalisation, by connecting countries, shall result in (a) lesser competition among producers. (b) greater competition among producers. (c) no change in competition among producers.

**Figures and tables** · kind: caption (supporting evidence)
- p73: BE CAREFUL! THAT’S
- p73: OUR WORLD YOU’RE
- p73: PLAYING WITH! SOMEDAY YOU’LL HAVE TO PAY THE
- p73: PRICE!
- p73: GLOBALISATION
- p73: IS FUN!
- p74: ...WE’VE SEEN GREAT IMPROVEMENTS
- p74: IN TRANSPORTATION...

## 5 FACTORS THAT HAVE ENABLED GLOBALISATION
unit: X.ECO.GLOBALISATION.5 | kind: section | pages: 74 | catalog: X.ECO.CF.FACTORS_THAT_HAVE_ENABLED_GLOBALISATION

### 5.1 Technology
unit: X.ECO.GLOBALISATION.5.1 | kind: subsection | parent: X.ECO.GLOBALISATION.5 | pages: 74–75 | catalog: X.ECO.CF.TECHNOLOGY
...
**Key terms (printed in bold)** · information and; communication technology; production of services

#### Box: Containers for transport of goods
unit: X.ECO.GLOBALISATION.5.1.box1 | kind: box | parent: X.ECO.GLOBALISATION.5.1 | page: 74
...
#### Box: Using IT in Globalisation
unit: X.ECO.GLOBALISATION.5.1.box2 | kind: box | parent: X.ECO.GLOBALISATION.5.1 | page: 75



**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 75
> 1. In the above example, underline the words describing the use of technology in production. 2. How is information technology connected with globalisation? Would globalisation have been possible without expansion of IT?

**Figures and tables** · kind: caption (supporting evidence)
- p75: IT LOOKS LIKE A VERY NICE MAGAZINE. BUT WHY ISN’T MY
- p75: NO, MY CHILD! THIS PRINTING PRESS IS NOT FOR ORDINARY INDIANS!
- p75: TEXTBOOK PRINTED LIKE THIS? I CAN HARDLY READ
- p75: THE WORDS IN MY BOOK!
- p75: ...BUT WHERE
- p75: IS THE ELECTRICITY?...

### 5.2 Liberalisation of foreign trade and foreign investment policy
unit: X.ECO.GLOBALISATION.5.2 | kind: subsection | parent: X.ECO.GLOBALISATION.5 | pages: 76 | catalog: X.ECO.CF.LIBERALISATION_FOREIGN_TRADE_FOREIGN_INVESTMENT_POLICY
...
**Key terms (printed in bold)** · trade barrier; Removing barriers or restrictions; set by the government is what is; known as liberalisation

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 76
> 1. What do you understand by liberalisation of foreign trade? 2. Tax on imports is one type of trade barrier. The government could also place a limit on the number of goods that can be imported. This is known as quotas. Can you explain, using the example of Chinese toys, how quotas can be used as trade barriers? Do you think this should be used? Discuss.

## 6 WORLD TRADE ORGANISATION
unit: X.ECO.GLOBALISATION.6 | kind: section | pages: 77–78 | catalog: X.ECO.CF.WORLD_TRADE_ORGANISATION
...
#### Box: Debate on Trade Practices
unit: X.ECO.GLOBALISATION.6.box1 | kind: box | parent: X.ECO.GLOBALISATION.6 | page: 77

You have seen in Chapter 2, that the agriculture sector provides the bulk of employment and a significant portion of the GDP in India. Compare this to a developed country such as the US with the share of agriculture in GDP at 1% and its share in total employment a tiny 0.5%! And yet this very small percentage of people who are engaged in agriculture in the US receive massive sums of money from the US government for production and for exports to other countries. Due to this massive money that they receive, US farmers can sell the farm products at abnormally low prices. The surplus farm products are sold in other country markets at low prices, adversely affecting farmers in these countries. A typical cotton farm in USA consists of thousands of acres owned by a huge corporation that will sell cotton abroad at lowered prices. Developing countries are, therefore, asking the developed country governments, “We have reduced trade barriers as per WTO rules. But you have ignored the rules of WTO and have continued to pay your farmers vast sums of money. You have asked our governments to stop supporting our farmers, but you are doing so yourselves. Is this free and fair trade? Is this free and fair trade?”

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 78
> 1. Fill in the blanks. WTO was started at the initiative of __________countries. The aim of the WTO is to ____________________. WTO establishes rules regarding ____ for all countries, and sees that ___________________ In practice, trade between countries is not ______________________________. Developing countries like India have ___________________, whereas developed countries, in many cases, have continued to provide protection to their producers. 2. What do you think can be done so that trade between countries is more fair? 3. In the above example, we saw that the US government gives massive sums of money to farmers for production. At times, governments also give support to promote production of certain types of goods, such as those which are environmentally friendly. Discuss whether these are fair or not.

**Figures and tables** · kind: caption (supporting evidence)
- p77: OBALISA OBALISATION TION AND THE I NDIAN E CONOMY 65
- p77: G LOBALISA

## 7 IMPACT OF GLOBALISATION IN INDIA
unit: X.ECO.GLOBALISATION.7 | kind: section | pages: 78–79 | catalog: X.ECO.CF.IMPACT_GLOBALISATION_IN_INDIA
...
**Key terms (printed in bold)** · MNCs; flexibility; top Indian; companies

#### Box: Steps to Attract Foreign Investment
unit: X.ECO.GLOBALISATION.7.box1 | kind: box | parent: X.ECO.GLOBALISATION.7 | page: 79



**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 79
> 1. How has competition benefited people in India? 2. Should more Indian companies emerge as MNCs? How would it benefit the people in the country? 3. Why do governments try to attract more foreign investment? 4. In Chapter 1, we saw what may be development for one may be destructive for others. The setting of SEZs has been opposed by some people in India. Find out who are these people and why are they opposing it.

**Figures and tables** · kind: caption (supporting evidence)
- p79: NOW, WE ARE READY
- p79: TO INVEST!

### 7.1 Small producers: Compete or perish
unit: X.ECO.GLOBALISATION.7.1 | kind: subsection | parent: X.ECO.GLOBALISATION.7 | pages: 80 | catalog: X.ECO.CF.SMALL_PRODUCERS_COMPETE_OR_PERISH
...
#### Box: Rising Competition
unit: X.ECO.GLOBALISATION.7.1.box1 | kind: box | parent: X.ECO.GLOBALISATION.7.1 | page: 80

Ravi did not expect that he would have to face a crisis in such a short period of his life as industrialist. Ravi took a loan from the bank to start his own company producing capacitors in 1992 in Hosur, an industrial town in Tamil Nadu. Capacitors are used in many electronic home appliances including tube lights, television etc. Within three years, he was able to expand production and had 20 workers working under him. used to buy different components including capacitors in bulk for the manufacture of television sets. However, competition from the MNC brands forced the Indian television companies to move into assembling activities for MNCs. Even when some of them bought capacitors, they would prefer to import as the price of the imported item was half the price charged by people like Ravi. Ravi now produces less than half the capacitors that he produced in the year 2000 and has only seven workers working for him. Many of Ravi’s friends in the same business in Hyderabad and Chennai have closed their units. His struggle to run his company started when the government removed restrictions on imports of capacitors as per its agreement at WTO in 2001. His main clients, the television companies,

**LET’S WORK THESE OUT** · kind: activity (supporting evidence) · page 80
> 1. What are the ways in which Ravi’s small production unit was affected by rising competition? 2. Should producers such as Ravi stop production because their cost of production is higher compared to producers in other countries? What do you think? 3. Recent studies point out that small producers in India need three things to compete better in the market (a) better roads, power, water, raw materials, marketing and information network (b) improvements and modernisation of technology (c) timely availability of credit at reasonable interest rates. l Can you explain how these three things would help Indian producers? l Do you think MNCs will be interested in investing in these? Why? l Do you think the government has a role in making these facilities available? Why? l Can you think of any other step that the government could take? Discuss.

**Figures and tables** · kind: caption (supporting evidence)
- p80: NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT

### 7.2 Competition and Uncertain Employment
unit: X.ECO.GLOBALISATION.7.2 | kind: subsection | parent: X.ECO.GLOBALISATION.7 | pages: 81–82 | catalog: X.ECO.CF.COMPETITION_UNCERTAIN_EMPLOYMENT
...
#### Box
unit: X.ECO.GLOBALISATION.7.2.box1 | kind: box | parent: X.ECO.GLOBALISATION.7.2 | page: 81
...
#### Box: A Garment Worker
unit: X.ECO.GLOBALISATION.7.2.box2 | kind: box | parent: X.ECO.GLOBALISATION.7.2 | page: 81
...
#### Box
unit: X.ECO.GLOBALISATION.8.box1 | kind: box | parent: X.ECO.GLOBALISATION.8 | page: 83
...
## Exercises
unit: X.ECO.GLOBALISATION.EX | kind: exercise (never used as evidence) | pages: 84–85
...
_______ with other countries. Moreover, the rising number of brands that we
...
consumers have more choices in the market, the effect of rising ___
...
NDERST NDERSTANDING ANDING E CONOMIC D EVEL EVELOPMENT OPMENT
13.Choose the most appropriate option.
(i) The past two decades of globalisation has seen rapid movements in (a) goods, services and people between countries. (b) goods, services and investments between countries. (c) goods, investments and people between countries.
(ii) The most common route for investments by MNCs in countries around the world is to
(a) set up new factories.
(b) buy existing local companies. (c) form partnerships with local companies.
...
(ii) Is the product exported to other countries? (iii) Are there MNCs among the producers?
(iv) Competition in the industry
(v) Conditions of work in the industry (vi) Has there been any major change in the industry in the past 15 years?
