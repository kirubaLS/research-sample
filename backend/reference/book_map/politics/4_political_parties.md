# Political Parties
chapter: X.POL.PARTIES | book: Democratic Politics – II (Political Science), Class X | edition: NCERT reprint 2026-27 | pages: 60–76
...
## Overview
unit: X.POL.PARTIES.0 | kind: intro | pages: 60 | catalog: X.POL.CF.PARTIES_OVERVIEW
...
unit: X.POL.PARTIES.1 | kind: section | pages: 61 | catalog: X.POL.CF.WHY_DO_WE_NEED_POLITICAL_PARTIES
...
### 1.1 Meaning
unit: X.POL.PARTIES.1.1 | kind: subsection | parent: X.POL.PARTIES.1 | pages: 61–62 | catalog: X.POL.CF.MEANING
review: Glossary term "Partisan" is printed in the margin beside Meaning/Functions. Kept under Meaning by position; the catalog puts it under Functions.
...
**Activity** · kind: activity (supporting evidence) · page 63
> Okay, granted that we can’t live without political parties. But tell me on what grounds do people support a political party? Categorise these photographs by the functions of political parties they illustrate. Find one photograph or news clipping from your own area for each of the functions listed above.

**Figures and tables** · kind: caption (supporting evidence)
- p64: 1
- p64: 2
- p64: 3
- p64: 1: Activists of BJP Mahila Morcha demonstrate against hike in prices of onions and LPG in Visakhapatnam. 2: Minister distributes ` One lakh cheque to the families of hooch victims at their houses. 3: Activists of CPI (M), CPI, OGP and JD (S) take out a rally in Bhubaneswar to protest against POSCO, the Korean steel company for being permitted by the State Government to export iron ore from Orissa to feed steel plants in China and Korea.

## 2 How many parties should we have?
unit: X.POL.PARTIES.2 | kind: section | pages: 64–67 | catalog: X.POL.CF.HOW_MANY_PARTIES_SHOULD_WE_HAVE
...
**Key terms (printed in bold)** · Aam Aadmi Party; (AAP); Bahujan Samaj; P a r t y ( B S P); Bharatiya Janata Party; (BJP); Communist Party; of India - Marxist; (CPI-M); Indian National Congress; (INC)

**Figures and tables** · kind: caption (supporting evidence)
- p67: For more details about registration and recognition of political parties by the Election Commission of India, visit https:// eci.gov.in

## 4 State parties
unit: X.POL.PARTIES.4 | kind: section | pages: 69–70 | catalog: X.POL.CF.STATE_PARTIES
...
**Key terms (printed in bold)** · National People’s Party; (NPP)

**Figures and tables** · kind: caption (supporting evidence)
- p70: Map not to scale

## 5 Challenges to political parties
unit: X.POL.PARTIES.5 | kind: section | pages: 71–73 | catalog: X.POL.CF.CHALLENGES_POLITICAL_PARTIES
...
**Key terms (printed in bold)** · lack of; internal democracy; money and; muscle power; meaningful choice

#### Box
unit: X.POL.PARTIES.5.box1 | kind: box | parent: X.POL.PARTIES.5 | page: 73
...
**Activity** · kind: activity (supporting evidence) · page 73
...
#### Box
unit: X.POL.PARTIES.6.box1 | kind: box | parent: X.POL.PARTIES.6 | page: 75

1. State the various functions political parties perform in a democracy. 2. What are the various challenges faced by political parties?

**Figures and tables** · kind: caption (supporting evidence)
- p74: Do you agree that this form of reforming political parties will be acceptable to them?

## Exercises
unit: X.POL.PARTIES.EX | kind: exercise (never used as evidence) | pages: 75–76
