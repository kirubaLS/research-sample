# Federalism
chapter: X.POL.FEDERALISM | book: Democratic Politics – II (Political Science), Class X | edition: NCERT reprint 2026-27 | pages: 27–42
...
## Overview
unit: X.POL.FEDERALISM.0 | kind: intro | pages: 27 | catalog: X.POL.CF.FEDERALISM_OVERVIEW
...
unit: X.POL.FEDERALISM.1 | kind: section | pages: 28–29 | catalog: X.POL.CF.WHAT_IS_FEDERALISM
...
**Key terms (printed in bold)** · ‘coming; together’ federations; ‘holding
...
**Key terms (printed in bold)** · Union List; State List; Concurrent List

#### Box
unit: X.POL.FEDERALISM.2.box1 | kind: box | parent: X.POL.FEDERALISM.2 | page: 31
...
### 3.1 Linguistic States
unit: X.POL.FEDERALISM.3.1 | kind: subsection | parent: X.POL.FEDERALISM.3 | pages: 33–34 | catalog: X.POL.CF.LINGUISTIC_STATES
...
**Figures and tables** · kind: caption (supporting evidence)
- p33:  Has your village / town / city
- p33: remained under the same State since Independence? If not, what was the name of the earlier State?  Can you identify names of three
- p33: States in 1947 that have been changed later?  Identify any three States which
- p33: have been carved out of bigger States.

### 3.2 Language policy
unit: X.POL.FEDERALISM.3.2 | kind: subsection | parent: X.POL.FEDERALISM.3 | pages: 34 | catalog: X.POL.CF.LANGUAGE_POLICY
...
### 3.3 Centre-State relations
unit: X.POL.FEDERALISM.3.3 | kind: subsection | parent: X.POL.FEDERALISM.3 | pages: 34–37 | catalog: X.POL.CF.CENTRE_STATE_RELATIONS
...
Language Proportion of speakers (%) Assamese 1.26 Bengali 8.03 Bodo 0.12 Dogri 0.21 Gujarati 4.58 Hindi 43.63 Kannada 3.61 Kashmiri 0.56 Konkani 0.19 Maithili 1.12 Malayalam 2.88 Manipuri 0.15 Marathi 6.86 Nepali 0.24 Odia 3.10 Punjabi 2.74 Sanskrit N Santali 0.61 Sindhi 0.23 Tamil 5.70 Telugu 6.70 Urdu 4.19

**Key terms (printed in bold)** · Language; Proportion of; speakers (%)
...
#### Box
unit: X.POL.FEDERALISM.3.3.box1 | kind: box | parent: X.POL.FEDERALISM.3.3 | page: 36

Scheduled Languages of India  Make a bar or pie chart on the basis of this information.  Prepare a map of linguistic diversity of India by shading the region where each of these languages is spoken on the map of India.  Find out about any three languages that are spoken in India but are not included in this table.

#### Box: Linguistic diversity of India
unit: X.POL.FEDERALISM.3.3.box2 | kind: box | parent: X.POL.FEDERALISM.3.3 | page: 36



#### Box
unit: X.POL.FEDERALISM.3.3.box3 | kind: box | parent: X.POL.FEDERALISM.3.3 | page: 37

Take the example of your own state or any other state that was affected by linguistic reorganisation. Write a short note for or against the argument given by the author here on the basis of that example. ‘ Read the following excerpts from an article by noted historian, Ramachandra Guha, that appeared in the Times of India on November 1, 2006:

**Activity** · kind: activity (supporting evidence) · page 34
> Why Hindi? Why not Bangla or Telugu? Are you suggesting that regionalism is good for our democracy? Are you serious?
...
**Figures and tables** · kind: caption (supporting evidence)
- p35: The States Plead for More Powers
- p35: Perils of Running a Coalition Government
- p35: Here are two cartoons showing the relationship between Centre and States. Should the State go to the Centre with a begging bowl? How can the leader of a coalition keep the partners of government satisfied?
- p35: © Ajith Ninan - India Today Book of Cartoons
- p35: © Kutty - Laughing with Kutty

## 4 Decentralisation in India
unit: X.POL.FEDERALISM.4 | kind: section | pages: 38–41 | catalog: X.POL.CF.DECENTRALISATION_IN_INDIA
...
Governments are specified in the Constitution and they have exclusive jurisdiction on their respective subjects. C. Sri Lanka is a federation because the country is divided into
provinces. D. India is no longer a federation because some powers of the States
