...
chapter: X.POL.OUTCOMES | book: Democratic Politics – II (Political Science), Class X | edition: NCERT reprint 2026-27 | pages: 77–88
...
## Overview
unit: X.POL.OUTCOMES.0 | kind: intro | pages: 77 | catalog: X.POL.CF.OUTCOMES_OVERVIEW
...
unit: X.POL.OUTCOMES.1 | kind: section | pages: 78 | catalog: X.POL.CF.HOW_DO_WE_ASSESS_DEMOCRACY_S_OUTCOMES
...
**Activity** · kind: activity (supporting evidence) · page 78
...
- p78: © RK Laxman - Brushing up the years
- p78: Is democracy all about coping with multiple pressures and accommodating diverse demands?

## 2 Accountable, responsive and legitimate government
unit: X.POL.OUTCOMES.2 | kind: section | pages: 79–80 | catalog: X.POL.CF.ACCOUNTABLE_RESPONSIVE_LEGITIMATE_6070F3
...
**Activity** · kind: activity (supporting evidence) · page 80
...
**Figures and tables** · kind: caption (supporting evidence)
- p79: Governmental Secrecy
- p79: Can you think of what and how the government knows about you and your family (for example ration cards and voter identity cards)? What are the sources of information for you about the government?
- p80: Democracy is preferred
- p80: over dictatorship everywhere except
- p80: Very few doubt the suitability of democracy for their own country How suitable is democracy for your country?
- p80: Pakistan South Asia 28
- p80: 62 10
- p80: Bangladesh India Nepal Pakistan Sri Lanka Democracy is preferable 69 70 62 37 71 Sometimes dictatorship is better 6 9 10 14 11
- p80: Doesn’t matter to me 25 21 28 49 18

## 3 Economic growth and development
unit: X.POL.OUTCOMES.3 | kind: section | pages: 81–82 | catalog: X.POL.CF.ECONOMIC_GROWTH_DEVELOPMENT
...
**Key terms (printed in bold)** · Table 2; Inequality of income in selected countries; Name of the; Countries; % share of national; income

#### Box: Poor Kids democracy Economic outcomes of
unit: X.POL.OUTCOMES.3.box1 | kind: box | parent: X.POL.OUTCOMES.3 | page: 82
...
**Figures and tables** · kind: caption (supporting evidence)
- p81: The Rich Get Buff
- p81: Cartoon on this page and next three pages tell us about the disparities between the rich and poor. Should the gains of economic growth be evenly distributed? How can the poor get a voice for a better share in a nation? What can the poor countries do to receive a greater share in the world’s wealth?
- p82: Table 1
- p82: Rates of economic growth for different countries, 1950 – 2000
- p82: Type of regimes and countries Growth Rate All democratic regimes 3.95 All dictatorial regimes 4.42 Poor countries under dictatorship 4.34 Poor countries under democracy 4.28

## 4 Reduction of inequality and poverty
unit: X.POL.OUTCOMES.4 | kind: section | pages: 83–84 | catalog: X.POL.CF.REDUCTION_INEQUALITY_POVERTY
...
**Activity** · kind: activity (supporting evidence) · page 83
...
**Figures and tables** · kind: caption (supporting evidence)
- p83: Voice of the Poor
- p84: World’s Wealth Owned by a Few

## 5 Accommodation of social diversity
unit: X.POL.OUTCOMES.5 | kind: section | pages: 84–85 | catalog: X.POL.CF.ACCOMMODATION_SOCIAL_DIVERSITY
...
**Activity** · kind: activity (supporting evidence) · page 84
...
- p86: Sri Lanka 65
- p86: 0 80
- p86: Rosa Parks Still Inspires
- p86: The above cartoon and graph illustrate a point made in this section (Dignity and freedom of the citizens). Underline the sentences from this section which connect to the cartoon or graph.

## Exercises
unit: X.POL.OUTCOMES.EX | kind: exercise (never used as evidence) | pages: 87–88

there is absence of any domination and conflict.
4. Identify the challenges to democracy in the following descriptions. Also suggest policy/institutional mechanism to deepen democracy in the given situations:  Following a High Court directive, a temple in Orissa that had
separate entry doors for dalits and nondalits allowed entry for all from the same door.  A large number of farmers are committing suicide in different
states of India.  Following an allegation of killing of three civilians in Gandwara
