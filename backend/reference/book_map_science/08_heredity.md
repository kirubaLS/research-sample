# Heredity
chapter: X.SCI.HEREDITY | book: Science, Class X | edition: NCERT reprint 2026-27 | pages: 143–148
...
## Introduction
unit: X.SCI.HEREDITY.0 | kind: intro | pages: 143 | catalog: X.SCI.CF.HEREDITY_INTRODUCTION
...
unit: X.SCI.HEREDITY.8.1 | kind: section | pages: 143–144 | catalog: X.SCI.CF.ACCUMULATION_VARIATION_DURING_A948B1
...
unit: X.SCI.HEREDITY.8.2.1 | kind: subsection | parent: X.SCI.HEREDITY.8.2 | pages: 144 | catalog: X.SCI.CF.INHERITED_TRAITS
...
**Activity 8.1** · kind: activity (supporting evidence) · page 144
...
unit: X.SCI.HEREDITY.8.2.2 | kind: subsection | parent: X.SCI.HEREDITY.8.2 | pages: 144–146 | catalog: X.SCI.CF.RULES_FOR_THE_INHERITANCE_OF_TRAITS_MENDEL_S_CONTRIBUTIONS
...
**Key terms (printed in bold)** · Gregor Johann Mendel (1822–1884)

#### Box
unit: X.SCI.HEREDITY.8.2.2.box1 | kind: box | parent: X.SCI.HEREDITY.8.2.2 | page: 145
...
**Figures and tables** · kind: caption (supporting evidence)
- p144: (b)
- p144: Figure 8.2 (a) Free and (b) attached earlobes. The lowest part of the ear, called the earlobe, is closely attached to the side of the head in some of us, and not in others. Free and attached earlobes are two variants found in human populations.
- p144: Heredity 129
- p145: Figure 8.3 Inheritance of traits over two generations Activity 8.2
- p146: Figure 8.4

### 8.2.3 How do these Traits get Expressed?
unit: X.SCI.HEREDITY.8.2.3 | kind: subsection | parent: X.SCI.HEREDITY.8.2 | pages: 146–147 | catalog: X.SCI.CF.HOW_DO_THESE_TRAITS_GET_EXPRESSED
...
**Figures and tables** · kind: caption (supporting evidence)
- p147: Figure 8.6 Sex determination in human beings

## What you have learnt
unit: X.SCI.HEREDITY.WHAT_YOU_HAVE_LEARNT | kind: summary | pages: 148 | catalog: X.SCI.CF.HEREDITY_WHAT_YOU_HAVE_LEARNT

• Variations arising during the process of reproduction can be inherited. • These variations may lead to increased survival of the individuals. • Sexually reproducing individuals have two copies of genes for the same trait. If the copies are not identical, the trait that gets expressed is called the dominant trait and the other is called the recessive trait. • Traits in one individual may be inherited separately, giving rise to new combinations of traits in the offspring of sexual reproduction. • Sex is determined by different factors in various species. In human beings, the sex of the child depends on whether the paternal chromosome is X (for girls) or Y (for boys).

## Exercises
unit: X.SCI.HEREDITY.EX | kind: exercise (never used as evidence) | pages: 148–148

1. A Mendelian experiment consisted of breeding tall pea plants bearing violet flowers with short pea plants bearing white flowers. The progeny all bore violet flowers, but almost half of them were short. This suggests that the genetic make-up of the tall parent can be depicted as (a) TW (b) Tw (c) TtWW (d) TtWw 2. A study found that children with light-coloured eyes are likely to have parents with light-coloured eyes. On this basis, can we say anything about whether the light eye colour trait is dominant or recessive? Why or why not? 3. Outline a project which aims to find the dominant coat colour in dogs. 4. How is the equal genetic contribution of male and female parents ensured in the progeny?
Heredity 133
