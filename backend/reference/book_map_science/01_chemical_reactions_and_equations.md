...
chapter: X.SCI.CHEMRXN | book: Science, Class X | edition: NCERT reprint 2026-27 | pages: 16–31
...
## Introduction
unit: X.SCI.CHEMRXN.0 | kind: intro | pages: 16–17 | catalog: X.SCI.CF.CHEMRXN_INTRODUCTION
...
From the above three activities, we can say that any of the following observations helps us to determine whether a chemical reaction has taken place – n change in state n change in colour n evolution of a gas n change in temperature.
...
#### Box
unit: X.SCI.CHEMRXN.0.box1 | kind: box | parent: X.SCI.CHEMRXN.0 | page: 16

n milk is left at room temperature during summers. n an iron tawa/pan/nail is left exposed to humid atmosphere. n grapes get fermented. n food is cooked. n food gets digested in our body. n we respire.

**Activity 1.1** · kind: activity (supporting evidence) · page 16
...
**Activity 1.2** · kind: activity (supporting evidence) · page 17
> 

**Activity 1.3** · kind: activity (supporting evidence) · page 17
> • Take lead nitrate solution in a test tube. • Take a few zinc granules in a conical flask or a test tube. • Add dilute hydrochloric acid or sulphuric acid to this (Fig. 1.2). CAUTION: Handle the acid with care. • Add potassium iodide solution to this. • Do you observe anything happening around the zinc granules? • What do you observe? • Touch the conical flask or test tube. Is there any change in its temperature?

**Figures and tables** · kind: caption (supporting evidence)
- p16: “Facts are not science — as the dictionary is not literature.”
- p16: Martin H. Fischer
- p16: Figure 1.1 Burning of a magnesium ribbon in air and collection of magnesium oxide in a watch-glass

## 1.1 CHEMICAL EQUATIONS
unit: X.SCI.CHEMRXN.1.1 | kind: section | pages: 17 | catalog: X.SCI.CF.CHEMICAL_EQUATIONS

Activity 1.1 can be described as – when a magnesium ribbon is burnt in oxygen, it gets converted to magnesium oxide. This description of a chemical reaction in a sentence form is quite long. It can be written in a shorter form. The simplest way to do this is to write it in the form of a word-equation. The word-equation for the above reaction would be – Magnesium + Oxygen → Magnesium oxide (1.1) (Reactants) (Product)
...
**Figures and tables** · kind: caption (supporting evidence)
- p17: Figure 1.2 Formation of hydrogen gas by the action of dilute sulphuric acid on zinc

### 1.1.1 Writing a Chemical Equation
unit: X.SCI.CHEMRXN.1.1.1 | kind: subsection | parent: X.SCI.CHEMRXN.1.1 | pages: 18 | catalog: X.SCI.CF.WRITING_CHEMICAL_EQUATION

Is there any other shorter way for representing chemical equations? Chemical equations can be made more concise and useful if we use chemical formulae instead of words. A chemical equation represents a chemical reaction. If you recall formulae of magnesium, oxygen and magnesium oxide, the above word-equation can be written as – Mg + O2 → MgO (1.2) Count and compare the number of atoms of each element on the LHS and RHS of the arrow. Is the number of atoms of each element the same on both the sides? If yes, then the equation is balanced. If not, then the equation is unbalanced because the mass is not the same on both sides of the equation. Such a chemical equation is a skeletal chemical equation for a reaction. Equation (1.2) is a skeletal chemical equation for the burning of magnesium in air.

### 1.1.2 Balanced Chemical Equations
unit: X.SCI.CHEMRXN.1.1.2 | kind: subsection | parent: X.SCI.CHEMRXN.1.1 | pages: 18–20 | catalog: X.SCI.CF.BALANCED_CHEMICAL_EQUATIONS
...
The above word-equation may be represented by the following chemical equation – Zn + H2SO4 → ZnSO4 + H2 (1.3) Let us examine the number of atoms of different elements on both sides of the arrow.

As the number of atoms of each element is the same on both sides of the arrow, Eq. (1.3) is a balanced chemical equation. Let us try to balance the following chemical equation – Fe + H2O → Fe3O4 + H2 (1.4)
...
To equalise the number of atoms, it must be remembered that we cannot alter the formulae of the compounds or elements involved in the reactions. For example, to balance oxygen atoms we can put coefficient ‘4’ as 4 H2O and not H2O4 or (H2O)4. Now the partly balanced equation becomes – Fe + 4 H2O → Fe3O4 + H2
...
The numbers of atoms of elements on both sides of Eq. (1.9) are equal. This equation is now balanced. This method of balancing chemical equations is called hit-and-trial method as we make trials to balance the equation by using the smallest whole number coefficient. Step VII: Writing Symbols of Physical States Writing Symbols of Physical States Carefully examine the above balanced Eq. (1.9). Does this equation tell us anything about the physical state of each reactant and product? No information has been given in this equation about their physical states. To make a chemical equation more informative, the physical states of the reactants and products are mentioned along with their chemical formulae. The gaseous, liquid, aqueous and solid states of reactants and products are represented by the notations (g), (l), (aq) and (s), respectively. The word aqueous (aq) is written if the reactant or product is present as a solution in water. The balanced Eq. (1.9) becomes 3Fe(s) + 4H2O(g) → Fe3O4(s) + 4H2(g) (1.10) Note that the symbol (g) is used with H2O to indicate that in this reaction water is used in the form of steam. Usually physical states are not included in a chemical equation unless it is necessary to specify them. Sometimes the reaction conditions, such as temperature, pressure, catalyst, etc., for the reaction are indicated above and/or below the arrow in the equation. For example – CO(g) + 2H (g) 2 340atm CH OH(l) 3  →  (1.11)

Using these steps, can you balance Eq. (1.2) given in the text earlier?

**Key terms (printed in bold)** · Step I; Step II; Step III; Step IV; Step V; Step VI; Step VII

#### Box
unit: X.SCI.CHEMRXN.1.1.2.box1 | kind: box | parent: X.SCI.CHEMRXN.1.1.2 | page: 18

Zn 1 1 H 2 2 S 1 1 O 4 4 Fe 1 3 H 2 2 O 1 4 (i) Initial 1 (in H2O) 4 (in Fe3O4) (ii) To balance 1×4 4 (1.6) (partly balanced equation) (i) Initial 8 (in 4 H2O) 2 (in H2) (ii) To balance 8 2 × 4 (1.7) (partly balanced equation) (i) Initial 1 (in Fe) 3 (in Fe3O4) (ii) To balance 1×3 3 (1.9) (balanced equation) 6CO (aq) 12H O(l) C H O (aq) 6O 2 2 6 12 6 + + Sunlight Chlorophyll  →  2 2 (aq) 6H O(l) + (1.12)

**In-text questions** · kind: intext_question (never used as evidence) · page 21
> 1. Why should a magnesium ribbon be cleaned before burning in air? 2. Write the balanced equation for the following chemical reactions. (i) Hydrogen + Chlorine → Hydrogen chloride acid solution (in water) to produce sodium chloride solution and water. ? (ii) Barium chloride + Aluminium sulphate → Barium sulphate + Aluminium chloride (iii) Sodium + Water → Sodium hydroxide + Hydrogen 3. Write a balanced chemical equation with state symbols for the following reactions. (i) Solutions of barium chloride and sodium sulphate in water react to give insoluble barium sulphate and the solution of sodium chloride. (ii) Sodium hydroxide solution (in water) reacts with hydrochloric

**Figures and tables** · kind: caption (supporting evidence)
- p18: Element Number of atoms in Number of atoms reactants (LHS) in products (RHS)
- p18: Chemical Reactions and Equations 3
- p19: Element Number of atoms Number of atoms in reactants (LHS) in products (RHS)
- p19: Atoms of In reactants In products oxygen
- p19: Atoms of In reactants In products hydrogen
- p20: Atoms of In reactants In products iron
- p20: (Glucose)
- p20: Chemical Reactions and Equations 5

## 1.2 TYPES OF CHEMICAL REACTIONS
unit: X.SCI.CHEMRXN.1.2 | kind: section | pages: 21 | catalog: X.SCI.CF.TYPES_CHEMICAL_REACTIONS
...
unit: X.SCI.CHEMRXN.1.2.1 | kind: subsection | parent: X.SCI.CHEMRXN.1.2 | pages: 21–22 | catalog: X.SCI.CF.COMBINATION_REACTION

Calcium oxide reacts vigorously with water to produce slaked lime (calcium hydroxide) releasing a large amount of heat. CaO(s) + H2O(l) → Ca(OH)2(aq) + Heat (1.13) (Quick lime) (Slaked lime)
...
(iii) The decomposition of vegetable matter into compost is also an example of an exothermic reaction. Identify the type of the reaction taking place in Activity 1.1, where heat is given out along with the formation of a single product.

#### ? w o • K  u o Y  o D
unit: X.SCI.CHEMRXN.1.2.1.box1 | kind: box | parent: X.SCI.CHEMRXN.1.2.1 | page: 22

(Glucose)

**Activity 1.4** · kind: activity (supporting evidence) · page 21
...
**Figures and tables** · kind: caption (supporting evidence)
- p21: Figure 1.3 Formation of slaked lime by the reaction of calcium oxide with water
- p22: Chemical Reactions and Equations 7

### 1.2.2 Decomposition Reaction
unit: X.SCI.CHEMRXN.1.2.2 | kind: subsection | parent: X.SCI.CHEMRXN.1.2 | pages: 23–25 | catalog: X.SCI.CF.DECOMPOSITION_REACTION
...
Silver bromide also behaves in the same way. 2AgBr(s) Sunlight  →  2Ag(s) + Br2(g) (1.23)
...
**Activity 1.5** · kind: activity (supporting evidence) · page 23
> • Take about 2 g ferrous sulphate crystals in a dry boiling tube. • Note the colour of the ferrous sulphate crystals. • Heat the boiling tube over the flame of a burner or spirit lamp as shown in Fig. 1.4. • Observe the colour of the crystals after heating. (Ferrous sulphate) (Ferric oxide) (Limestone) (Quick lime)

**Activity 1.6** · kind: activity (supporting evidence) · page 23
> • Take about 2 g lead nitrate powder in a boiling tube. • Hold the boiling tube with a pair of tongs and heat it over a flame, as shown in Fig. 1.5. • What do you observe? Note down the change, if any. (Lead nitrate) (Lead oxide) (Nitrogen (Oxygen) dioxide)

**Activity 1.7** · kind: activity (supporting evidence) · page 24
...
**Activity 1.8** · kind: activity (supporting evidence) · page 24
> • Take about 2 g silver chloride in a china dish. • What is its colour? • Place this china dish in sunlight for some time (Fig. 1.7). • Observe the colour of the silver chloride after some time.

**In-text questions** · kind: intext_question (never used as evidence) · page 25
...
**Figures and tables** · kind: caption (supporting evidence)
- p23: Figure 1.4 Correct way of heating the boiling tube containing crystals of ferrous sulphate and of smelling the odour
- p23: Figure 1.5 Heating of lead nitrate and emission of nitrogen dioxide
- p24: Figure 1.6 Electrolysis of water
- p24: Figure 1.7 Silver chloride turns grey in sunlight to form silver metal
- p24: Chemical Reactions and Equations 9
- p25: Carry out the following Activity

### 1.2.3 Displacement Reaction
unit: X.SCI.CHEMRXN.1.2.3 | kind: subsection | parent: X.SCI.CHEMRXN.1.2 | pages: 25–26 | catalog: X.SCI.CF.DISPLACEMENT_REACTION

Why does the iron nail become brownish in colour and the blue colour of copper sulphate solution fades? The following chemical reaction takes place in this Activity– Fe(s) + CuSO4(aq) → FeSO4(aq) + Cu(s) (1.24) (Copper sulphate) (Iron sulphate) In this reaction, iron has displaced or removed another element, copper, from copper sulphate solution. This reaction is known as displacement reaction. Other examples of displacement reactions are Zn(s) + CuSO4(aq) → ZnSO4(aq) + Cu(s) (1.25) (Copper sulphate) (Zinc sulphate) Pb(s) + CuCl2(aq) → PbCl2(aq) + Cu(s) (1.26) (Copper chloride) (Lead chloride) Zinc and lead are more reactive elements than copper. They displace copper from its compounds.

**Activity 1.9** · kind: activity (supporting evidence) · page 25
...
**Figures and tables** · kind: caption (supporting evidence)
- p25: Figure 1.8 (a) Iron nails dipped in copper sulphate solution
- p26: Figure 1.8 (b) Iron nails and copper sulphate solutions compared before and after the experiment

### 1.2.4 Double Displacement Reaction
unit: X.SCI.CHEMRXN.1.2.4 | kind: subsection | parent: X.SCI.CHEMRXN.1.2 | pages: 26–27 | catalog: X.SCI.CF.DOUBLE_DISPLACEMENT_REACTION
...
What causes this? The white precipitate of BaSO4 is formed by the reaction of 2– 4 SO and Ba2+. The other product formed is sodium chloride which remains in the solution. Such reactions in which there is an exchange of ions between the reactants are called double displacement reactions.

Recall Activity 1.2, where you have mixed the solutions of lead(II) nitrate and potassium iodide. (i) What was the colour of the precipitate formed? Can you name the compound precipitated? (ii) Write the balanced chemical equation for this reaction. (iii) Is this also a double displacement reaction?

**Activity 1.10** · kind: activity (supporting evidence) · page 26
> • Take about 3 mL of sodium sulphate solution in a test tube. • In another test tube, take about 3 mL of barium chloride solution. • Mix the two solutions (Fig. 1.9). • What do you observe? Na2SO4(aq) + BaCl2(aq) → BaSO4(s) + 2NaCl(aq) (1.27) (Sodium (Barium (Barium (Sodium sulphate) chloride) sulphate) chloride)

**Figures and tables** · kind: caption (supporting evidence)
- p26: Figure 1.9 Formation of barium sulphate and sodium chloride
- p26: Chemical Reactions and Equations 11

### 1.2.5 Oxidation and Reduction
unit: X.SCI.CHEMRXN.1.2.5 | kind: subsection | parent: X.SCI.CHEMRXN.1.2 | pages: 27–28 | catalog: X.SCI.CF.OXIDATION_REDUCTION
...
2Cu + O2 Heat  →  2CuO (1.28) If hydrogen gas is passed over this heated material (CuO), the black coating on the surface turns brown as the reverse reaction takes place and copper is obtained. CuO +H Cu+H O 2 2 Heat  →  (1.29) If a substance gains oxygen during a reaction, it is said to be oxidised. If a substance loses oxygen during a reaction, it is said to be reduced. During this reaction (1.29), the copper(II) oxide is losing oxygen and is being reduced. The hydrogen is gaining oxygen and is being oxidised. In other words, one reactant gets oxidised while the other gets reduced during a reaction. Such reactions are called oxidation-reduction reactions or redox reactions.

(1.30)

Some other examples of redox reactions are: ZnO + C → + Zn CO (1.31) MnO HCl MnCl H O Cl 2 4 2 + → + + (1.32)
...
**Activity 1.11** · kind: activity (supporting evidence) · page 27
> • Heat a china dish containing about 1 g copper powder (Fig. 1.10). • What do you observe?

**Figures and tables** · kind: caption (supporting evidence)
- p27: Figure 1.10 Oxidation of copper to copper oxide

## 1.3 HAVE YOU OBSERVED THE EFFECTS OF OXIDATION REACTIONS IN EVERYDAY LIFE?
unit: X.SCI.CHEMRXN.1.3 | kind: section | pages: 28 | catalog: X.SCI.CF.HAVE_YOU_OBSERVED_EFFECTS_43DD88

### 1.3.1 Corrosion
unit: X.SCI.CHEMRXN.1.3.1 | kind: subsection | parent: X.SCI.CHEMRXN.1.3 | pages: 28 | catalog: X.SCI.CF.CORROSION
...
### 1.3.2 Rancidity
unit: X.SCI.CHEMRXN.1.3.2 | kind: subsection | parent: X.SCI.CHEMRXN.1.3 | pages: 28 | catalog: X.SCI.CF.RANCIDITY
...
**In-text questions** · kind: intext_question (never used as evidence) · page 28
...
**Figures and tables** · kind: caption (supporting evidence)
- p28: Chemical Reactions and Equations 13

## What you have learnt
unit: X.SCI.CHEMRXN.WHAT_YOU_HAVE_LEARNT | kind: summary | pages: 29 | catalog: X.SCI.CF.CHEMRXN_WHAT_YOU_HAVE_LEARNT
...
## Exercises
unit: X.SCI.CHEMRXN.EX | kind: exercise (never used as evidence) | pages: 29–31

1. Which of the statements about the reaction below are incorrect? 2PbO(s) + C(s) → 2Pb(s) + CO2(g) (a) Lead is getting reduced. (b) Carbon dioxide is getting oxidised. (c) Carbon is getting oxidised. (d) Lead oxide is getting reduced.
(i) (a) and (b) (ii) (a) and (c) (iii) (a), (b) and (c) (iv) all 2. Fe2O3 + 2Al → Al2O3 + 2Fe The above reaction is an example of a (a) combination reaction. (b) double displacement reaction.
...
13. What is the difference between displacement and double displacement reactions? Write equations for these reactions. 14. In the refining of silver, the recovery of silver from silver nitrate solution involved displacement by copper metal. Write down the reaction involved. 15. What do you mean by a precipitation reaction? Explain by giving examples. 16. Explain the following in terms of gain or loss of oxygen with two examples each.
(a) Oxidation (b) Reduction 17. A shiny brown coloured element ‘X’ on heating in air becomes black in colour. Name the element ‘X’ and the black coloured compound formed. 18. Why do we apply paint on iron articles? 19. Oil and fat containing food items are flushed with nitrogen. Why? 20. Explain the following terms with one example each.
