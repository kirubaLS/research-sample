...
chapter: X.SCI.CARBON | book: Science, Class X | edition: NCERT reprint 2026-27 | pages: 73–93
...
## Introduction
unit: X.SCI.CARBON.0 | kind: intro | pages: 73 | catalog: X.SCI.CF.CARBON_INTRODUCTION
...
Things made Things made Others of metal of glass/clay Activity 4.1
...
**Key terms (printed in bold)** · Things made; Others; of metal; of glass/clay

#### Box
unit: X.SCI.CARBON.0.box1 | kind: box | parent: X.SCI.CARBON.0 | page: 73
...
unit: X.SCI.CARBON.4.1 | kind: section | pages: 73–76 | catalog: X.SCI.CF.BONDING_IN_CARBON_COVALENT_BOND
...
**Key terms (printed in bold)** · Allotropes of carbon

#### Box
unit: X.SCI.CARBON.4.1.box1 | kind: box | parent: X.SCI.CARBON.4.1 | page: 74

Acetic acid (CH3COOH) 290 391 Chloroform (CHCl3) 209 334 Ethanol (CH3CH2OH) 156 351 Methane (CH4) 90 111

#### Box
unit: X.SCI.CARBON.4.1.box2 | kind: box | parent: X.SCI.CARBON.4.1 | page: 76



**In-text questions** · kind: intext_question (never used as evidence) · page 76
> 1. What would be the electron dot structure of carbon dioxide which has the formula CO2? 2. What would be the electron dot structure of a molecule of sulphur which is made up of eight atoms of sulphur? (Hint – The eight atoms of sulphur are joined together in the form of a ring.)

**Figures and tables** · kind: caption (supporting evidence)
- p74: Table 4.1 Melting points and boiling points of some
- p74: Compound Melting Boiling point (K) point (K)
- p74: Carbon and its Compounds 59
- p75: Figure 4.1 A molecule of hydrogen
- p75: Figure 4.2 Single bond between two hydrogen atoms
- p75: Figure 4.3 Double bond between two oxygen atoms
- p75: Figure 4.4 Triple bond between two nitrogen atoms
- p76: Figure 4.5 Electron dot structure for methane
- p76: The structure of diamond The structure of C-60 Buckminsterfullerene
- p76: The structure of graphite
- p76: Carbon and its Compounds 61

## 4.2 VERSATILE NATURE OF CARBON
unit: X.SCI.CARBON.4.2 | kind: section | pages: 77–78 | catalog: X.SCI.CF.VERSATILE_NATURE_OF_CARBON
...
**Key terms (printed in bold)** · Organic compounds

#### Box
unit: X.SCI.CARBON.4.2.box1 | kind: box | parent: X.SCI.CARBON.4.2 | page: 78



### 4.2.1 Saturated and Unsaturated Carbon Compounds
unit: X.SCI.CARBON.4.2.1 | kind: subsection | parent: X.SCI.CARBON.4.2 | pages: 78–79 | catalog: X.SCI.CF.SATURATED_UNSATURATED_CARBON_COMPOUNDS
...
The electron dot structure of ethane is shown in Fig. 4.6(c). Can you draw the structure of propane, which has the molecular formula C3H8 in a similar manner? You will see that the valencies of all the atoms are satisfied by single bonds between them. Such carbon compounds are called saturated compounds. These compounds are normally not very reactive.
...
Carbon-carbon atoms linked together with a single bond (Step 1). We see that one valency per carbon atom remains unsatisfied (Step 2). This can be satisfied only if there is a double bond between the two carbons (Step 3).
...
**Figures and tables** · kind: caption (supporting evidence)
- p78: Figure 4.6 (a) Carbon atoms linked together with a single bond
- p78: Figure 4.6 (c) Electron dot structure of ethane
- p78: Figure 4.6 (b) Each carbon atom bonded to three hydrogen atoms
- p78: Carbon and its Compounds 63
- p79: Figure 4.7 Structure of ethene

### 4.2.2 Chains, Branches and Rings
unit: X.SCI.CARBON.4.2.2 | kind: subsection | parent: X.SCI.CARBON.4.2 | pages: 79–81 | catalog: X.SCI.CF.CHAINS_BRANCHES_RINGS
...
No. of C Name Formula Structure atoms
...
**Key terms (printed in bold)** · No. of C; Name; Formula; Structure; atoms

#### Box
unit: X.SCI.CARBON.4.2.2.box1 | kind: box | parent: X.SCI.CARBON.4.2.2 | page: 81

Cl/Br Halo- (Chloro/bromo) —Cl, —Br alkane (substitutes for hydrogen atom) Oxygen 1. Alcohol —OH 2. Aldehyde 3. Ketone 4. Carboxylic acid

**Figures and tables** · kind: caption (supporting evidence)
- p79: Table 4.2 Formulae and structures of saturated compounds of carbon and hydrogen
- p80: Figure 4.8 (a) Two possible carbon-skeletons
- p80: Figure 4.8 (b) Complete molecules for two structures with formula C4H10 We see that both these structures have the same formula C4H10. Such compounds with identical molecular formula but different structures are called structural isomers.
- p80: (a) (b)
- p80: Figure 4.9 Structure of cyclohexane (a) carbon skeleton (b) complete molecule
- p80: Figure 4.10 Structure of benzene All these carbon compounds which contain only carbon and hydrogen are called hydrocarbons. Among these, the saturated hydrocarbons are called alkanes. The unsaturated hydrocarbons which contain one or more double bonds are called alkenes. Those containing one or more triple bonds are called alkynes. 4.2.3 Will you be my Friend?
- p80: Carbon and its Compounds 65
- p81: Table 4.3 Some functional groups in carbon compounds
- p81: Hetero Class of Formula of atom compounds functional group

### 4.2.4 Homologous Series
unit: X.SCI.CARBON.4.2.4 | kind: subsection | parent: X.SCI.CARBON.4.2 | pages: 81–82 | catalog: X.SCI.CF.HOMOLOGOUS_SERIES
...
CH4 and C2H6 — these differ by a –CH2unit C2H6 and C3H8 — these differ by a –CH2unit What is the difference between the next pair – propane and butane (C4H10)?
...
#### Box
unit: X.SCI.CARBON.4.2.5.box1 | kind: box | parent: X.SCI.CARBON.4.2.5 | page: 83

1. Halo alkane Prefix-chloro, Chloropropane Bromopropane 2. Alcohol Suffix - ol Propanol 3. Aldehyde Suffix - al Propanal 4. Ketone Suffix - one Propanone 5. Carboxylic acid Suffix - oic acid Propanoic acid 6. Alkenes Suffix - ene Propene 7. Alkynes Suffix - yne Propyne

**In-text questions** · kind: intext_question (never used as evidence) · page 83
> 1. How many structural isomers can you draw for pentane? 2. What are the two properties of carbon which lead to the huge number of carbon compounds we see around us? 3. What will be the formula and electron dot structure of cyclopentane? 4. Draw the structures for the following compounds. (i) Ethanoic acid (ii) Bromopentane* (iii) Butanone (iv) Hexanal. *Are structural isomers possible for bromopentane? 5. How would you name the following compounds? (i) CH3—CH2—Br (ii) (iii)

**Figures and tables** · kind: caption (supporting evidence)
- p82: Carbon and its Compounds 67
- p83: Table 4.4 Nomenclature of organic compounds
- p83: Class of Prefix/Suffix Example compounds

## 4.3 CHEMICAL PROPERTIES OF CARBON COMPOUNDS
unit: X.SCI.CARBON.4.3 | kind: section | pages: 84 | catalog: X.SCI.CF.CHEMICAL_PROPERTIES_CARBON_COMPOUNDS
...
### 4.3.1 Combustion
unit: X.SCI.CARBON.4.3.1 | kind: subsection | parent: X.SCI.CARBON.4.3 | pages: 84–85 | catalog: X.SCI.CF.COMBUSTION

Carbon, in all its allotropic forms, burns in oxygen to give carbon dioxide along with the release of heat and light. Most carbon compounds also release a large amount of heat and light on burning. These are the oxidation reactions that you learnt about in the first Chapter – (i) C + O2 → CO2 + heat and light (ii) CH4 + O2 → CO2 + H2O + heat and light (iii) CH3CH2OH + O2 → CO2 + H2O + heat and light Balance the latter two reactions like you learnt in the first Chapter.
...
**Key terms (printed in bold)** · Why do substances burn with or without a flame?; Formation of coal and petroleum

#### ? w o • K  u o Y  o D
unit: X.SCI.CARBON.4.3.1.box1 | kind: box | parent: X.SCI.CARBON.4.3.1 | page: 85



#### Box
unit: X.SCI.CARBON.4.3.1.box2 | kind: box | parent: X.SCI.CARBON.4.3.1 | page: 85



**Activity 4.3** · kind: activity (supporting evidence) · page 84
> 

**Activity 4.4** · kind: activity (supporting evidence) · page 84
> CAUTION: This Activity needs the teacher’s assistance. • Light a bunsen burner and adjust the air hole at the base to get different types of flames/presence of smoke. • Take some carbon compounds (naphthalene, camphor, alcohol) one by one on a spatula and burn them. • When do you get a yellow, sooty flame? • Observe the nature of the flame and note whether smoke is produced. • When do you get a blue flame? • Place a metal plate above the flame. Is there a deposition on the plate in case of any of the compounds?

**Figures and tables** · kind: caption (supporting evidence)
- p84: Carbon and its Compounds 69

### 4.3.2 Oxidation
unit: X.SCI.CARBON.4.3.2 | kind: subsection | parent: X.SCI.CARBON.4.3 | pages: 85–86 | catalog: X.SCI.CF.OXIDATION
...
We see that some substances are capable of adding oxygen to others. These substances are known as oxidising agents. Alkaline potassium permanganate or acidified potassium dichromate are oxidising alcohols to acids, that is, adding oxygen to the starting material. Hence they are known as oxidising agents.

**Activity 4.5** · kind: activity (supporting evidence) · page 85
...
unit: X.SCI.CARBON.4.3.3 | kind: subsection | parent: X.SCI.CARBON.4.3 | pages: 86 | catalog: X.SCI.CF.ADDITION_REACTION
...
unit: X.SCI.CARBON.4.3.4 | kind: subsection | parent: X.SCI.CARBON.4.3 | pages: 86 | catalog: X.SCI.CF.SUBSTITUTION_REACTION
...
**In-text questions** · kind: intext_question (never used as evidence) · page 86
> 1. Why is the conversion of ethanol to ethanoic acid an oxidation reaction? 2. A mixture of oxygen and ethyne is burnt for welding. Can you tell why a mixture of ethyne and air is not used?

## 4.4 SOME IMPORTANT CARBON COMPOUNDS – ETHANOL AND ETHANOIC ACID
unit: X.SCI.CARBON.4.4 | kind: section | pages: 86 | catalog: X.SCI.CF.SOME_IMPORTANT_CARBON_COMPOUNDS_ETHANOL_AND_ETHANOIC_ACID
...
Hot Conc. −CH OH → 2 H SO 2 4

Hot Conc. CH −CH OH →CH = CH + H O 3 2 H SO 2 2 2 2 4
...
**Key terms (printed in bold)** · How do alcohols affect living beings?; Alcohol as a fuel

#### ? w o • K  u o Y  o D
unit: X.SCI.CARBON.4.4.1.box1 | kind: box | parent: X.SCI.CARBON.4.4.1 | page: 87



#### Box
unit: X.SCI.CARBON.4.4.1.box2 | kind: box | parent: X.SCI.CARBON.4.4.1 | page: 88



**Activity 4.6** · kind: activity (supporting evidence) · page 87
> Teacher’s demonstration – • Drop a small piece of sodium, about the size of a couple of grains of rice, into ethanol (absolute alcohol). • What do you observe? • How will you test the gas evolved?

**Figures and tables** · kind: caption (supporting evidence)
- p87: 3 2 Hot Conc.

### 4.4.2 Properties of Ethanoic Acid
unit: X.SCI.CARBON.4.4.2 | kind: subsection | parent: X.SCI.CARBON.4.4 | pages: 88–89 | catalog: X.SCI.CF.PROPERTIES_OF_ETHANOIC_ACID
...
CH COOC H C H OH+CH COONa 3 2 5 2 5 3 NaOH (ii) Reaction with a base: Like mineral acids, ethanoic acid reacts with a base such as sodium hydroxide to give a salt (sodium ethanoate or commonly called sodium acetate) and water: NaOH + CH3COOH → CH3COONa + H2O How does ethanoic acid react with carbonates and hydrogencarbonates? Let us perform an activity to find out.

(iii) Reaction with carbonates and hydrogencarbonates: Ethanoic acid reacts with carbonates and hydrogencarbonates to give rise to a salt, carbon dioxide and water. The salt produced is commonly called sodium acetate. 2CH3COOH + Na2CO3 → 2CH3COONa + H2O + CO2 CH3COOH + NaHCO3 → CH3COONa + H2O + CO2

**Key terms (printed in bold)** · Reactions of ethanoic acid; How does ethanoic acid react with carbonates and; hydrogencarbonates?

**Activity 4.7** · kind: activity (supporting evidence) · page 88
...
**Activity 4.8** · kind: activity (supporting evidence) · page 88
> • Take 1 mL ethanol (absolute alcohol) and 1 mL glacial acetic acid along with a few drops of concentrated sulphuric acid in a test tube. • Warm in a water-bath for at least five minutes as shown in Fig. 4.11. • Pour into a beaker containing 20-50 mL of water and smell the resulting mixture. CH COOH CH CH OH CH C C CH CH H O 3 3 2 Acid O

**Activity 4.9** · kind: activity (supporting evidence) · page 89
> • Set up the apparatus as shown in Chapter 2, Activity 2.5. • Take a spatula full of sodium carbonate in a test tube and add 2 mL of dilute ethanoic acid. • What do you observe? • Pass the gas produced through freshly prepared lime-water. What do you observe? • Can the gas produced by the reaction between ethanoic acid and sodium carbonate be identified by this test? • Repeat this Activity with sodium hydrogencarbonate instead of sodium carbonate.

**In-text questions** · kind: intext_question (never used as evidence) · page 89
> 1. How would you distinguish experimentally between an alcohol and a carboxylic acid? 2. What are oxidising agents?

**Figures and tables** · kind: caption (supporting evidence)
- p88: Figure 4.11 Formation of ester
- p88:    
- p88: (E
- p88: thanoic acid) (Ethanol) (Ester)
- p88: Carbon and its Compounds 73

## 4.5 SOAPS AND DETERGENTS
unit: X.SCI.CARBON.4.5 | kind: section | pages: 89–91 | catalog: X.SCI.CF.SOAPS_AND_DETERGENTS
...
**Key terms (printed in bold)** · Micelles

#### Box
unit: X.SCI.CARBON.4.5.box1 | kind: box | parent: X.SCI.CARBON.4.5 | page: 90



**Activity 4.10** · kind: activity (supporting evidence) · page 89
> • Take about 10 mL of water each in two test tubes. • Add a drop of oil (cooking oil) to both the test tubes and label them as A and B. • To test tube B, add a few drops of soap solution. • Now shake both the test tubes vigourously for the same period of time. • Can you see the oil and water layers separately in both the test tubes immediately after you stop shaking them? • Leave the test tubes undisturbed for some time and observe. Does the oil layer separate out? In which test tube does this happen first? Figure 4.12 Formation of micelles

**Activity 4.11** · kind: activity (supporting evidence) · page 91
...
**Activity 4.12** · kind: activity (supporting evidence) · page 91
> • Take two test tubes with about 10 mL of hard water in each. • Add five drops of soap solution to one and five drops of detergent solution to the other. • Shake both test tubes for the same period. • Do both test tubes have the same amount of foam? • In which test tube is a curdy solid formed?

**In-text questions** · kind: intext_question (never used as evidence) · page 91
...
Group Activity
I Use molecular model kits to make models of the compounds you have learnt in this Chapter. II • Take about 20 mL of castor oil/cotton seed oil/linseed oil/soyabean oil in a beaker. Add 30 mL of 20 % sodium hydroxide solution. Heat the mixture with continuous stirring for a few minutes till the mixture thickens. Add 5-10 g of common salt to this. Stir the mixture well and allow it to cool.
