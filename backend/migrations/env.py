...
The database URL comes from app.config so a deployment has exactly one place where the
connection string lives, and so the ``postgres://`` normalisation applies here too.
"""
